...
export default function Welcome() {
  ...
  return html`<main class="main-bubble modal">
    ...
    <p>
      My job is to help you get started, and to show you the ropes around here.
    </p>
    <p>
      It might feel like a lot, but I promise--you'll get the hang of it before
      too long!
    </p>
    <p>
      First, let's create a username and profile so that your friends can
      connect with you!
    </p>
