...
function da$1(a) {
  return (
    (Object.prototype.hasOwnProperty.call(a, ea$1) && a[ea$1]) ||
    (a[ea$1] = ++fa$1)
  );
}
var ea$1 = "closure_uid_" + ((1e9 * Math.random()) >>> 0),
  fa$1 = 0;
function ha$1(a, b, c) {
...
const ma$1 = Array.prototype.indexOf
    ? function (a, b) {
...
var ta$1 = String.prototype.trim
  ? function (a) {
      return a.trim();
    }
  : function (a) {
...
var Ha$1 = w(x$1, "Opera"),
  y = w(x$1, "Trident") || w(x$1, "MSIE"),
  Ia$1 = w(x$1, "Edge"),
  Ja$1 = Ia$1 || y,
  Ka$1 =
    w(x$1, "Gecko") &&
    !(w(x$1.toLowerCase(), "webkit") && !w(x$1, "Edge")) &&
    !(w(x$1, "Trident") || w(x$1, "MSIE")) &&
    !w(x$1, "Edge"),
...
function Ra$1() {
  return Fa$1(function () {
    let a = 0;
    const b = ta$1(String(Na$1)).split("."),
      c = ta$1("9").split("."),
    ...
    for (let h = 0; 0 == a && h < d; h++) {
      ...
      do {
        ...
        a =
          ...
          ua$1(0 == e[2].length, 0 == f[2].length) ||
          ua$1(e[2], f[2]);
        e = e[3];
        f = f[3];
      } while (0 == a);
...
$a$1.prototype.add = function (a, b, c, d, e) {
  ...
  -1 < h
    ? ((b = a[h]), c || (b.fa = !1))
    : ((b = new Ya$1(b, this.src, f, !!d, e)), (b.fa = c), a.push(b));
  return b;
};
function bb(a, b) {
  var c = b.type;
...
function nb(a, b, c, d, e) {
  if (Array.isArray(b)) for (var f = 0; f < b.length; f++) nb(a, b[f], c, d, e);
    ...
    ((d = p(d) ? !!d.capture : !!d), (c = hb(c)), a && a[B$1])
      ? ((a = a.i),
        (b = String(b).toString()),
        b in a.g &&
          ((f = a.g[b]),
...
function ob(a) {
  if ("number" !== typeof a && a && !a.ca) {
    ...
    if (b && b[B$1]) bb(b.i, a);
      ...
      (c = jb(b))
        ? (bb(c, a), 0 == c.h && ((c.src = null), (b[cb] = null)))
        : Za$1(a);
    }
  }
}
...
function D$1(a, b) {
  ...
  a = a.P;
  d = b.type || b;
  if ("string" === typeof b) b = new z$1(b, a);
  else if (b instanceof z$1) b.target = b.target || a;
  else {
    var e = b;
    b = new z$1(d, a);
    Aa$1(b, e);
  ...
  e = qb(h, d, !1, b) && e;
  if (c)
    for (f = 0; f < c.length; f++) (h = b.g = c[f]), (e = qb(h, d, !1, b) && e);
}
C$1.prototype.M = function () {
  ...
  if (this.i) {
    var a = this.i,
      c;
    for (c in a.g) {
      for (var d = a.g[c], e = 0; e < d.length; e++) Za$1(d[e]);
      delete a.g[c];
      a.h--;
    }
  }
...
class Ib extends v {
  ...
  M() {
    super.M();
    this.g &&
      (l.clearTimeout(this.g), (this.g = null), (this.i = !1), (this.h = null));
  }
}
function E(a) {
  v.call(this);
    ...
    if (a == this.g)
      a: {
        ...
        if (
          ...
          (3 != r ||
            Ja$1 ||
            (this.g && (this.h.h || this.g.ga() || oc$1(this.g))))
        ) {
            ...
            this.U
              ? (tc$1(this, r, h),
                Ja$1 &&
                  this.i &&
                  3 == r &&
                  (Kb(this.V, this.W, "tick", this.fb), this.W.start()))
              : (F$1(this.j, this.m, h, null), sc$1(this, h));
            4 == r && P(this);
            this.i &&
              !this.I &&
              (4 == r ? uc$1(this.l, this) : ((this.i = !1), lc$1(this)));
          } else
  ...
  d
    ? 0 < c.length &&
      ...
      b.g == a &&
        ...
        !b.L &&
        (b.h.info(
          "Great, no buffering proxy detected. Bytes received: " + c.length
        ),
        wc$1(b),
        (b.L = !0),
        J$1(11)))
    : (F$1(a.j, a.m, c, "[Invalid Chunked Response]"), P(a), rc$1(a));
}
k$1.fb = function () {
  if (this.g) {
    var a = O$1(this.g),
      b = this.g.ga();
    this.C < b.length &&
      (pc$1(this), tc$1(this, a, b), this.i && 4 != a && lc$1(this));
  }
};
function vc$1(a, b) {
  var c = a.C,
        ...
        if (Array.isArray(d) && 3 == d.length) {
          ...
          if (0 == e[0])
            a: {
              if (!c.u) {
                if (c.g)
                  if (c.g.F + 3e3 < a.F) zc$1(c), Ac$1(c);
                  else break a;
                Bc$1(c);
                J$1(18);
              }
          ...
          if (2 == c.G)
            if ("c" == m[0]) {
              ...
              null != Da &&
                ...
                ((d = 1.5 * Da),
                (c.K = d),
                c.h.info("backChannelRequestTimeoutMs_=" + d));
              d = c;
              const ca = a.g;
              if (ca) {
                const Ea = ca.g
                  ? ca.g.getResponseHeader("X-Client-Wire-Protocol")
                  : null;
                if (Ea) {
                  var f = d.i;
                  !f.g &&
                    (w(Ea, "spdy") || w(Ea, "quic") || w(Ea, "h2")) &&
                    ((f.j = f.l),
                    (f.g = new Set()),
                    f.h && (Dc$1(f, f.h), (f.h = null)));
                }
                if (d.D) {
                  const xb = ca.g
                    ? ca.g.getResponseHeader("X-HTTP-Session-Id")
                    : null;
...
function Kc$1(a, b) {
  ...
  else if (ba$1(a) || "string" === typeof a) na$1(a, b, void 0);
  else {
...
function S(a, b) {
  ...
  if (1 < c) {
    ...
    if (a instanceof S)
      for (c = a.T(), d = 0; d < c.length; d++) this.set(c[d], a.get(c[d]));
  ...
  if (a instanceof U$1) {
    ...
    a && (c = String(a).match(Mc$1))
      ? ((this.g = !!b),
        ...
        Sc$1(this, c[6] || "", !0),
        (this.o = Tc$1(c[7] || "")))
      : ((this.g = !!b), (this.h = new Rc$1(null, this.g)));
}
U$1.prototype.toString = function () {
  var a = [],
    b = this.j;
  b && a.push(Uc$1(b, Vc$1, !0), ":");
  var c = this.i;
  if (c || "file" == b)
    a.push("//"),
      (b = this.s) && a.push(Uc$1(b, Vc$1, !0), "@"),
      a.push(
  ...
  if ((c = this.l))
    this.i && "/" != c.charAt(0) && a.push("/"),
      a.push(Uc$1(c, "/" == c.charAt(0) ? Wc$1 : Xc$1, !0));
...
function Sc$1(a, b, c) {
  b instanceof Rc$1
    ? ((a.h = b), Zc$1(a.h, a.g))
    : (c || (b = Uc$1(b, $c$1)), (a.h = new Rc$1(b, a.g)));
}
function R(a, b, c) {
  a.h.set(b, c);
}
...
function dd(a, b) {
  ...
  T(a.g.h, b) &&
    ...
    (a = a.g),
    T(a.h, b) && (delete a.h[b], a.i--, a.g.length > 2 * a.i && Lc$1(a)));
}
function ed(a, b) {
  V(a);
  b = W$1(a, b);
...
k$1.R = function (a) {
  ...
  if ("string" === typeof a)
    ...
    a = this.g.R();
    for (var c = 0; c < a.length; c++) b = qa$1(b, a[c]);
  }
  return b;
};
k$1.set = function (a, b) {
...
function mc$1(a, b, c) {
  dd(a, b);
  0 < c.length &&
    ((a.i = null), a.g.set(W$1(a, b), ra$1(c)), (a.h += c.length));
}
...
function nd(a, b) {
  ...
  if (l.Image) {
    const d = new Image();
    d.onload = ja$1(od, c, d, "TestLoadImage: loaded", !0, b);
    d.onerror = ja$1(od, c, d, "TestLoadImage: error", !1, b);
    d.onabort = ja$1(od, c, d, "TestLoadImage: abort", !1, b);
    d.ontimeout = ja$1(od, c, d, "TestLoadImage: timeout", !1, b);
...
k$1.ea = function (a, b, c, d) {
  ...
  try {
    Ad(this),
      0 < this.B &&
        ((this.K = Bd(this.g))
          ? ((this.g.timeout = this.B), (this.g.ontimeout = q$1(this.pa, this)))
...
function Ed(a) {
  if (
    a.h &&
    "undefined" != typeof goog &&
    (!a.C[1] || 4 != O$1(a) || 2 != a.ba())
  )
    if (a.v && 4 == O$1(a)) Gb(a.Fa, 0, a);
      ...
      try {
        ...
        if (c) D$1(a, "complete"), D$1(a, "success");
        else {
          a.m = 6;
          try {
  ...
  if (this.m)
    if (((this.m = null), 1 == this.G)) {
      if (!a) {
          ...
          a: {
            ...
            for (var c = 0; c < this.l.length; c++) {
              b: {
                ...
                if (
                  "__data__" in d.g &&
                  ((d = d.g.__data__), "string" === typeof d)
                ) {
                  d = d.length;
                  break b;
                }
        ...
        this.ja
          ? (R(c, "$req", b), R(c, "SID", "null"), (e.$ = !0), ic$1(e, c, null))
          : ic$1(e, c, b);
        this.G = 2;
      }
    } else
      3 == this.G &&
        (a ? Qd(this, a) : 0 == this.l.length || id(this.i) || Qd(this));
};
function Qd(a, b) {
  var c;
  b ? (c = b.m) : (c = a.V++);
...
function uc$1(a, b) {
  ...
  if (a.g == b) {
    ...
    a.g = null;
    var d = 2;
  } else if (yc$1(a.i, b)) (c = b.D), Fc$1(a.i, b), (d = 1);
  else return;
  a.I = b.N;
  if (0 != a.G)
    if (b.i)
...
function Q$1(a, b) {
  ...
  if (2 == b) {
    ...
    var d = q$1(a.jb, a);
    c ||
      ((c = new U$1("//www.google.com/images/cleardot.gif")),
      (l.location && "http" == l.location.protocol) || Oc$1(c, "https"),
      jc$1(c));
    nd(c.toString(), d);
  } else J$1(2);
  a.G = 0;
...
k$1.jb = function (a) {
  a
    ? (this.h.info("Successfully pinged google.com"), J$1(2))
    : (this.h.info("Failed to ping google.com"), J$1(1));
};
function Ld(a) {
  a.G = 0;
  a.I = -1;
...
function Ec$1(a, b, c) {
  let d = ad(c);
  if ("" != d.i) b && Pc$1(d, b + "." + d.i), Qc$1(d, d.m);
  else {
    const e = l.location;
    d = bd(e.protocol, b ? b + "." + e.hostname : e.hostname, +e.port, c);
  }
  a.aa &&
    xa$1(a.aa, function (e, f) {
      R(d, f, e);
    });
  b = a.D;
  c = a.sa;
...
function nc$1(a, b, c) {
  ...
  b = c && a.Ba && !a.qa ? new X$1(new pd({ ib: !0 })) : new X$1(a.qa);
  b.L = a.H;
  return b;
}
function Sd() {}
...
/** A user with a null UID. */ (C.UNAUTHENTICATED = new C(null)),
  ...
  (C.GOOGLE_CREDENTIALS = new C("google-credentials-uid")),
  (C.FIRST_PARTY = new C("first-party-uid")),
        ...
        ? this.auth.getToken(e).then((e) =>
            ...
            this.i !== t
              ...
              ? (U("string" == typeof e.accessToken),
                new W(e.accessToken, this.currentUser))
              : null
          )
...
class nt {
  constructor(t, e) {
    (this.previousValue = t),
      e &&
        ((e.sequenceNumberHandler = (t) => this.I(t)),
...
class at {
  ...
  _compareTo(t) {
    return this.seconds === t.seconds
      ? rt(this.nanoseconds, t.nanoseconds)
      : rt(this.seconds, t.seconds);
  }
  /**
...
class dt {
  constructor(t, e, n) {
    void 0 === e ? (e = 0) : e > t.length && L(),
      void 0 === n ? (n = t.length - e) : n > t.length - e && L(),
      (this.segments = t),
      (this.offset = e),
      (this.len = n);
  }
...
/** Converts the possible Proto types for Blobs into a ByteString. */ function At(
  t
) {
...
function Mt(t) {
  return "nullValue" in t
    ...
    : "mapValue" in t
    ? Rt(t)
      ? 4 /* ServerTimestampValue */
      : Ht(t)
      ? 9007199254740991 /* MaxValue */
      : 10 /* ObjectValue */
    : L();
}

/** Tests `left` and `right` for equality based on the backend semantics. */ function Ot(
  t,
  e
) {
  if (t === e) return !0;
  ...
  switch (n) {
    ...
    case 8 /* GeoPointValue */:
      return (function (t, e) {
        return (
          Et(t.geoPointValue.latitude) === Et(e.geoPointValue.latitude) &&
          Et(t.geoPointValue.longitude) === Et(e.geoPointValue.longitude)
        );
      })(t, e);
    ...
    case 2 /* NumberValue */:
      return (function (t, e) {
        if ("integerValue" in t && "integerValue" in e)
          return Et(t.integerValue) === Et(e.integerValue);
    ...
    case 10 /* ObjectValue */:
      return (function (t, e) {
        ...
        for (const t in n)
          if (n.hasOwnProperty(t) && (void 0 === s[t] || !Ot(n[t], s[t])))
            return !1;
        return !0;
      })(
...
function Ut(t) {
  return "nullValue" in t
    ...
    ? t.stringValue
    : "bytesValue" in t
    ? At(t.bytesValue).toBase64()
    : "referenceValue" in t
    ? ((n = t.referenceValue), xt.fromName(n).toString())
    : "geoPointValue" in t
    ...
    ? (function (t) {
        ...
        /** Returns a reference value for the provided database and key. */ t.arrayValue
      )
    : "mapValue" in t
    ? (function (t) {
...
/** Creates a deep copy of `source`. */ function zt(t) {
  ...
  if (t.arrayValue) {
    ...
    for (let n = 0; n < (t.arrayValue.values || []).length; ++n)
      e.arrayValue.values[n] = zt(t.arrayValue.values[n]);
    return e;
  }
  return Object.assign({}, t);
}

/** Returns true if the Value represents the canonical {@link #MAX_VALUE} . */ function Ht(
  t
) {
  return (
    "__max__" === (((t.mapValue || {}).fields || {}).__type__ || {}).stringValue
  );
}

/** Returns the lowest value for the given value type (inclusive). */ function Jt(
  t
) {
  return "nullValue" in t
    ? kt
...
/** Returns the largest value for the given value type (exclusive). */ function Yt(
  t
) {
  return "nullValue" in t
    ? {
   ...
   */ field(t) {
    if (t.isEmpty()) return this.value;
    {
      ...
      for (let n = 0; n < t.length - 1; ++n)
        if (((e = (e.mapValue.fields || {})[t.get(n)]), !Wt(e))) return null;
...
/** Returns all directional (ascending/descending) segments for this index. */ function re(
  t
) {
...
function le(t, e) {
  ...
  return 0 !== n
    ? n
    : ((n = xt.comparator(t.documentKey, e.documentKey)),
      0 !== n ? n : rt(t.largestBatchId, e.largestBatchId));
}
...
class _e {
  constructor(t, e, n, s, i) {
    (this.key = t),
      (this.value = e),
      (this.color = null != n ? n : _e.RED),
      (this.left = null != s ? s : _e.EMPTY),
      (this.right = null != i ? i : _e.EMPTY),
...
// end LLRBEmptyNode
_e.EMPTY = new // Represents an empty node (a leaf node in the Red-Black Tree).
(class {
  constructor() {
    this.size = 0;
  }
  ...
  if (null === e.P) {
    ...
    null !== e.collectionGroup && (t += "|cg:" + e.collectionGroup),
      ...
      (t += e.filters
        .map((t) => {
          return (
            (e = t).field.canonicalString() + e.op.toString() + Lt(e.value)
          );
          var e;
        })
        .join(",")),
      ...
      (t += e.orderBy
        ...
        .join(",")),
      St(e.limit) || ((t += "|l:"), (t += e.limit)),
      e.startAt &&
        ((t += "|lb:"),
        (t += e.startAt.inclusive ? "b:" : "a:"),
        (t += e.startAt.position.map((t) => Lt(t)).join(","))),
      e.endAt &&
        ((t += "|ub:"),
        (t += e.endAt.inclusive ? "a:" : "b:"),
        (t += e.endAt.position.map((t) => Lt(t)).join(","))),
      (e.P = t);
  }
  return e.P;
}
...
function Te(t) {
  ...
  return (
    ...
    t.startAt &&
      ...
      (e += t.startAt.position.map((t) => Lt(t)).join(","))),
    t.endAt &&
      ((e += ", endAt: "),
      (e += t.endAt.inclusive ? "a:" : "b:"),
      (e += t.endAt.position.map((t) => Lt(t)).join(","))),
    `Target(${e})`
  );
}
...
function Ee(t, e) {
  ...
  for (let n = 0; n < t.orderBy.length; n++)
    if (!$e(t.orderBy[n], e.orderBy[n])) return !1;
  if (t.filters.length !== e.filters.length) return !1;
  for (let i = 0; i < t.filters.length; i++)
    if (
      ((n = t.filters[i]),
      (s = e.filters[i]),
      n.op !== s.op || !n.field.isEqual(s.field) || !Ot(n.value, s.value))
    )
      return !1;
  var n, s;
  return (
...
function Ae(t) {
  return (
    xt.isDocumentKey(t.path) &&
    null === t.collectionGroup &&
    0 === t.filters.length
  );
}

/** Returns the field filters that target the given field path. */ function Re(
  t,
  e
) {
...
/** Returns the number of segments of a perfect index for this target. */ class Ve extends class {} {
   ...
   */ static create(t, e, n) {
    return t.isKeyField()
      ? "in" /* IN */ === e || "not-in" /* NOT_IN */ === e
        ? this.V(t, e, n)
        : new ve(t, e, n)
      : "array-contains" /* ARRAY_CONTAINS */ === e
      ? new xe(t, n)
      : "in" /* IN */ === e
      ? new Ne(t, n)
      : "not-in" /* NOT_IN */ === e
      ? new ke(t, n)
      : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e
      ? new Me(t, n)
      : new Ve(t, e, n);
  }
  static V(t, e, n) {
  ...
  matches(t) {
    ...
    return "!=" /* NOT_EQUAL */ === this.op
      ? null !== e && this.v($t(e, this.value))
      : null !== e && Mt(this.value) === Mt(e) && this.v($t(e, this.value));
...
function Ce(t, e) {
  ...
  ).map((t) => xt.fromName(t.referenceValue));
}
...
/** A Filter that implements the array-contains-any operator. */ class Me extends Ve {
  ...
  matches(t) {
    const e = t.data.field(this.field);
    return (
      !(!Gt(e) || !e.arrayValue.values) &&
      e.arrayValue.values.some((t) => Ft(this.value.arrayValue, t))
    );
  }
}
...
/** Creates a new Query instance with the options provided. */ function qe(
  t,
  e,
  n,
  s,
...
/** Creates a new Query for a query that matches all documents at `path` */ function Ke(
  t
) {
  return new Ue(t);
}
 ...
 */ function ze(t) {
  ...
  if (null === e.D) {
    ...
    if (null !== t && null === n)
      ...
      t.isKeyField() || e.D.push(new Fe(t)),
        e.D.push(new Fe(mt.keyField(), "asc" /* ASCENDING */));
    else {
      let t = !1;
      for (const n of e.explicitOrderBy)
        e.D.push(n), n.field.isKeyField() && (t = !0);
      if (!t) {
 ...
 */ function He(t) {
  ...
  if (!e.C)
    if ("F" /* First */ === e.limitType)
      ...
      for (const n of ze(e)) {
        const e =
          "desc" /* DESCENDING */ === n.dir
            ? "asc" /* ASCENDING */
            : "desc"; /* DESCENDING */
        t.push(new Fe(n.field, e));
      }
      // We need to swap the cursors to match the now-flipped query ordering.
      const n = e.endAt ? new Oe(e.endAt.position, e.endAt.inclusive) : null,
        s = e.startAt ? new Oe(e.startAt.position, e.startAt.inclusive) : null;
...
/** Returns whether `doc` matches the constraints of `query`. */ function tn(
  t,
  e
) {
  return (
 ...
 */ function cn(t, e, n) {
  return t instanceof fn
    ? (function (t, e) {
        ...
        return (
          e && (n.fields.__previous_value__ = e),
          {
            mapValue: n,
          }
        );
  ...
  return t instanceof gn
    ? Kt((n = e)) ||
      (function (t) {
        ...
        /** Returns true if `value` is either an IntegerValue or a DoubleValue. */ n
      )
      ? e
      : {
          integerValue: 0,
  ...
  return (
    ...
    (function (t, e) {
      return (t instanceof dn && e instanceof dn) ||
        (t instanceof wn && e instanceof wn)
        ? ot(t.elements, e.elements, Ot)
        : t instanceof gn && e instanceof gn
        ? Ot(t.k, e.k)
        : t instanceof fn && e instanceof fn;
...
/** Returns true if the preconditions is valid for the given document. */ function Rn(
  t,
  e
) {
  ...
  t instanceof Cn
    ? (function (t, e, n) {
        ...
        const s = t.value.clone(),
          i = kn(t.fieldTransforms, e, n.transformResults);
        s.setAll(i),
    ...
    ? (function (t, e, n) {
        ...
        const s = kn(t.fieldTransforms, e, n.transformResults),
          i = e.data;
        i.setAll(Nn(t)),
          i.setAll(s),
 ...
 */ function Vn(t, e, n) {
  t instanceof Cn
    ...
    ? (function (t, e, n) {
        ...
        const s = Mn(t.fieldTransforms, n, e),
          i = e.data;
        i.setAll(Nn(t)),
          i.setAll(s),
          e.convertToFoundDocument(Dn(e), i).setHasLocalMutations();
      })(
        /**
...
/** A mutation that deletes the document at the given key. */ class On extends Pn {
  constructor(t, e) {
    super(),
      (this.key = t),
      (this.precondition = e),
 ...
 *     Code.UNKNOWN.
 */ ((Ln = Bn || (Bn = {}))[(Ln.OK = 0)] = "OK"),
  (Ln[(Ln.CANCELLED = 1)] = "CANCELLED"),
  (Ln[(Ln.UNKNOWN = 2)] = "UNKNOWN"),
  (Ln[(Ln.INVALID_ARGUMENT = 3)] = "INVALID_ARGUMENT"),
  (Ln[(Ln.DEADLINE_EXCEEDED = 4)] = "DEADLINE_EXCEEDED"),
  (Ln[(Ln.NOT_FOUND = 5)] = "NOT_FOUND"),
  (Ln[(Ln.ALREADY_EXISTS = 6)] = "ALREADY_EXISTS"),
  (Ln[(Ln.PERMISSION_DENIED = 7)] = "PERMISSION_DENIED"),
  (Ln[(Ln.UNAUTHENTICATED = 16)] = "UNAUTHENTICATED"),
  (Ln[(Ln.RESOURCE_EXHAUSTED = 8)] = "RESOURCE_EXHAUSTED"),
  (Ln[(Ln.FAILED_PRECONDITION = 9)] = "FAILED_PRECONDITION"),
  (Ln[(Ln.ABORTED = 10)] = "ABORTED"),
  (Ln[(Ln.OUT_OF_RANGE = 11)] = "OUT_OF_RANGE"),
  (Ln[(Ln.UNIMPLEMENTED = 12)] = "UNIMPLEMENTED"),
  (Ln[(Ln.INTERNAL = 13)] = "INTERNAL"),
  (Ln[(Ln.UNAVAILABLE = 14)] = "UNAVAILABLE"),
  (Ln[(Ln.DATA_LOSS = 15)] = "DATA_LOSS");
 ...
 */ class ts {
  ...
  static createSynthesizedRemoteEventForCurrentChange(t, e) {
    const n = new Map();
    return (
      n.set(t, es.createSynthesizedTargetChangeForCurrentChange(t, e)),
      new ts(ct.min(), n, Zn(), Qn(), Yn())
    );
  }
}
...
class os {
  ...
  /** Processes and adds the WatchTargetChange to the current set of changes. */ ht(
    t
  ) {
    ...
    this.st.forEach((n, s) => {
      ...
      if (i) {
        if (n.current && Ae(i.target)) {
          ...
          null !== this.it.get(e) ||
            this.It(s, e) ||
            this.ct(s, e, ne.newNoDocument(e, t));
        }
        n.j && (e.set(s, n.H()), n.J());
      }
    });
  ...
  at(t, e) {
    ...
    this.lt(t).Y(e.key, n),
      (this.it = this.it.insert(e.key, e)),
      (this.rt = this.rt.insert(e.key, this.Tt(e.key).add(t)));
  }
  /**
  ...
  ct(t, e, n) {
    ...
    this.It(t, e)
      ...
      : // The document may have entered and left the target before we raised a
        ...
        s.X(e),
      (this.rt = this.rt.insert(e, this.Tt(e).delete(t))),
      n && (this.it = this.it.insert(e, n));
  }
  removeTarget(t) {
    this.st.delete(t);
  }
   ...
   */ gt(t) {
    const e = this.lt(t).H();
    return (
      this.nt.getRemoteKeysForTarget(t).size +
...
/** Creates a Document proto from key and fields (but no create/update time) */ function Rs(
  t,
  e,
  n
) {
...
function Ps(t, e, n) {
  ...
  return (
    n && o.setHasCommittedMutations(), n ? o.setHasCommittedMutations() : o
  );
}
...
function Vs(t, e) {
  ...
  if ("targetChange" in e) {
    ...
    const s = (function (t) {
      ...
      r = (function (t, e) {
        return t.N
          ? (U(void 0 === e || "string" == typeof e),
            pt.fromBase64String(e || ""))
          : (U(void 0 === e || e instanceof Uint8Array),
    ...
    const i = ps(t, s.document.name),
      r = ws(s.document.updateTime),
      o = new te({
        mapValue: {
    ...
    s.document;
    const i = ps(t, s.document),
      r = s.readTime ? ws(s.readTime) : ct.min(),
      ...
      ? e.updateTransforms.map((e) =>
          (function (t, e) {
            ...
            if ("setToServerValue" in e)
              U("REQUEST_TIME" === e.setToServerValue), (n = new fn());
...
/** Encodes a single segment of a resource path into the given result */ function Qs(
  t,
  e
) {
  let n = e;
 ...
 */ function Ws(t) {
  ...
  const e = t.length;
  if ((U(e >= 2), 2 === e))
    return U("" === t.charAt(0) && "" === t.charAt(1)), _t.emptyPath();
 ...
 * information.
 */ const Ys = {},
  Xs = ["prefixPath", "collectionGroup", "readTime", "documentId"],
  Zs = ["prefixPath", "collectionGroup", "documentId"],
  ti = ["collectionGroup", "readTime", "prefixPath", "documentId"],
  ei = ["canonicalId", "targetId"],
  ni = ["targetId", "path"],
  si = ["path", "targetId"],
  ii = ["collectionId", "parent"],
  ri = ["indexId", "uid"],
  oi = ["uid", "sequenceNumber"],
  ui = [
    "indexId",
    "uid",
    "arrayValue",
  ...
  ai = ["indexId", "uid", "orderedDocumentKey"],
  ci = ["userId", "collectionPath", "documentId"],
  hi = ["userId", "collectionPath", "largestBatchId"],
  li = ["userId", "collectionGroup", "largestBatchId"],
  fi = [
    ...[
      ...[
        ...[
 ...
 */ class Ii {
  ...
  /** Deletes the specified database. */ static delete(t) {
    return (
      O("SimpleDb", "Removing database:", t),
      Pi(window.indexedDB.deleteDatabase(t)).toPromise()
    );
  }
   ...
   */ static St() {
    ...
    return (
      ...
      "YES" === (null === (t = process.env) || void 0 === t ? void 0 : t.Ct)
    );
  }
  /** Helper to get a typed SimpleDbStore from a transaction. */ static xt(
    t,
    e
  ) {
    return t.store(e);
   ...
   */ async Nt(t) {
    return (
      this.db ||
        (O("SimpleDb", "Opening database:", this.name),
        (this.db = await new Promise((e, n) => {
          ...
          (s.onsuccess = (t) => {
            ...
            (s.onupgradeneeded = (t) => {
              ...
              this.bt
                .kt(e, s.transaction, t.oldVersion, this.version)
                .next(() => {
                  O(
                    "SimpleDb",
  ...
  async runTransaction(t, e, n, s) {
    ...
    for (;;) {
      ...
      try {
        ...
        const e = pi.open(this.db, t, i ? "readonly" : "readwrite", n),
          r = s(e)
            .next((t) => (e.Pt(), t))
            .catch(
              (t) => (
...
/** An error that wraps exceptions that thrown during IndexedDB execution. */ class Ei extends Q {
  constructor(t, e) {
    super(G.UNAVAILABLE, `IndexedDB transaction '${t}' failed: ${e}`),
 ...
 */ class Ri {
  ...
  put(t, e) {
    ...
    return (
      void 0 !== e
        ? (O("SimpleDb", "PUT", this.store.name, t, e),
          (n = this.store.put(e, t)))
        : (O("SimpleDb", "PUT", this.store.name, "<auto-key>", t),
          (n = this.store.put(t))),
      Pi(n)
    );
  }
   ...
   */ get(t) {
    ...
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    return Pi(this.store.get(t)).next(
      (e) => (
        // Normalize nonexistence to null.
        void 0 === e && (e = null),
        O("SimpleDb", "GET", this.store.name, t, e),
        e
      )
    );
  }
 ...
 */ class Di {
   ...
   */ applyToLocalView(t) {
    ...
    for (const e of this.baseMutations)
      e.key.isEqual(t.key) && Vn(e, t, this.localWriteTime);
   ...
   */ applyToLocalDocumentSet(t) {
    ...
    this.mutations.forEach((e) => {
      ...
      this.applyToLocalView(s),
        n.isValidDocument() || s.convertToNoDocument(ct.min());
    });
  }
  keys() {
  ...
  isEqual(t) {
    return (
      ...
      ot(this.mutations, t.mutations, (t, e) => Sn(t, e)) &&
      ot(this.baseMutations, t.baseMutations, (t, e) => Sn(t, e))
    );
  }
}
 ...
 */ class Ni {
  ...
  /** Creates a new target data instance with an updated sequence number. */ withSequenceNumber(
    t
  ) {
    return new Ni(
      this.target,
...
/** Decodes a remote document from storage locally to a Document. */ function Mi(
  t,
  e
) {
  let n;
  if (e.document) n = Ps(t.Jt, e.document, !!e.hasCommittedMutations);
  else if (e.noDocument) {
    const t = xt.fromSegments(e.noDocument.path),
      s = Bi(e.noDocument.readTime);
    (n = ne.newNoDocument(t, s)),
    ...
    if (!e.unknownDocument) return L();
    {
      const t = xt.fromSegments(e.unknownDocument.path),
        s = Bi(e.unknownDocument.version);
...
/** Decodes a DbTarget into TargetData */ function Ui(t) {
  ...
  return (
    ...
    new Ni(
      ...
      e,
      n,
      pt.fromBase64String(t.resumeToken)
    )
  );
}

/** Encodes TargetData into a DbTarget for storage locally. */ function qi(
  t,
  e
) {
  const n = $i(e.snapshotVersion),
 ...
 */ class Hi {
  ...
  getOverlay(t, e) {
    return Ji(t)
      .get(Qi(this.userId, e))
      .next((t) => (t ? Gi(this.M, t) : null));
  }
  saveOverlays(t, e, n) {
    const s = [];
    return (
  ...
  getOverlaysForCollection(t, e, n) {
    ...
    return Ji(t)
      .qt("collectionPathOverlayIndex", r)
      .next((t) => {
        for (const e of t) {
          const t = Gi(this.M, e);
          s.set(t.getKey(), t);
    ...
    return Ji(t)
      .Wt(
        ...
        (t, e, n) => {
          ...
          const o = Gi(this.M, e);
          i.size() < s || o.largestBatchId === r
            ? (i.set(o.getKey(), o), (r = o.largestBatchId))
            : n.done();
        }
      )
      .next(() => i);
...
class Yi {
  ...
  te(t, e) {
    if ("nullValue" in t) this.ne(e, 5);
      ...
      "mapValue" in t
        ? Ht(t)
          ? this.ne(e, Number.MAX_SAFE_INTEGER)
          : (this.ce(t.mapValue, e), this.oe(e))
        : "arrayValue" in t
        ? (this.he(t.arrayValue, e), this.oe(e))
        : L();
  }
  re(t, e) {
   ...
   */ Ee(t) {
    const e =
        ...
        (function (t) {
          ...
          return (
            e.setFloat64(0, t, /* littleEndian= */ !1), new Uint8Array(e.buffer)
          );
        })(t),
      n = 0 != (128 & e[0]);
 ...
 */ class sr {
  constructor() {
    (this.De = new tr()),
      (this.Ce = new er(this.De)),
      (this.xe = new nr(this.De));
  }
  seed(t) {
    this.De.seed(t);
  }
...
/** Represents an index entry saved by the SDK in persisted storage. */ class ir {
   ...
   */ ke() {
    ...
    return (
      ...
      e !== t ? n.set([0], this.directionalValue.length) : ++n[n.length - 1],
...
function rr(t, e) {
  ...
  return 0 !== n
    ? n
    : ((n = or(t.arrayValue, e.arrayValue)),
      0 !== n
        ? n
        : ((n = or(t.directionalValue, e.directionalValue)),
 ...
 */ class ur {
  constructor(t) {
    (this.collectionId =
      null != t.collectionGroup ? t.collectionGroup : t.path.lastSegment()),
      (this.Me = t.orderBy),
      (this.Oe = []);
  ...
  Le(t, e) {
    ...
    const n =
      "array-contains" /* ARRAY_CONTAINS */ === t.op ||
      "array-contains-any" /* ARRAY_CONTAINS_ANY */ === t.op;
    return (2 /* CONTAINS */ === e.kind) === n;
  }
  Ue(t, e) {
    return (
      !!t.field.isEqual(e.fieldPath) &&
      ((0 /* ASCENDING */ === e.kind && "asc" /* ASCENDING */ === t.dir) ||
        (1 /* DESCENDING */ === e.kind && "desc" /* DESCENDING */ === t.dir))
    );
  }
}
 ...
 */ class cr {
  ...
  add(t) {
    const e = t.lastSegment(),
      n = t.popLast(),
      s = this.index[e] || new we(_t.comparator),
      i = !s.has(n);
...
class lr {
          ...
          return yi
            .forEach(i, (i, r) => {
              ...
              const u = (function (t, e) {
                  ...
                  for (const e of Re(t, n.fieldPath))
                    switch (e.op) {
                ...
                a = (function (t, e) {
                  const n = new Map();
                  for (const s of re(e))
                    for (const e of Re(t, s.fieldPath))
                      switch (e.op) {
                        case "==" /* EQUAL */:
                        case "in" /* IN */:
                ...
                c = (function (t, e) {
                  ...
                  for (const i of re(e)) {
                    const e =
                      0 /* ASCENDING */ === i.kind
                        ? Pe(t, i.fieldPath, t.startAt)
                        : be(t, i.fieldPath, t.startAt);
                ...
                h = (function (t, e) {
                  ...
                  for (const i of re(e)) {
                    const e =
                      0 /* ASCENDING */ === i.kind
                        ? be(t, i.fieldPath, t.endAt)
                        : Pe(t, i.fieldPath, t.endAt);
                    n.push(e.value), s && (s = e.inclusive);
                  }
                  return new Oe(n, s);
                })(r, i),
                ...
                f = this.We(i, r, h),
                d = this.ze(i, r, a),
                _ = this.He(i.indexId, u, l, c.inclusive, f, h.inclusive, d);
              return yi.forEach(_, (i) =>
                n.Gt(i, e.limit).next((e) => {
                  e.forEach((e) => {
   ...
   */ He(t, e, n, s, i, r, o) {
    ...
    const u = (null != e ? e.length : 1) * Math.max(n.length, i.length),
      ...
      c = [];
    for (let h = 0; h < u; ++h) {
      const u = e ? this.Je(e[h / a]) : hr,
        l = this.Ye(t, u, n[h % a], s),
        f = this.Xe(t, u, i[h % a], r),
        d = o.map((e) => this.Ye(t, u, e, /* inclusive= */ !0));
      c.push(...this.createRange(l, f, d));
    }
    return c;
  }
  /** Generates the lower bound for `arrayValue` and `directionalValue`. */ Ye(
    t,
    e,
    n,
    s
  ...
  /** Generates the upper bound for `arrayValue` and `directionalValue`. */ Xe(
    t,
    e,
    n,
    s
   ...
   */ ze(t, e, n) {
    ...
    for (const r of re(t)) {
      const t = n[i++];
      for (const n of s)
        if (this.en(e, r.fieldPath) && Gt(t)) s = this.nn(s, r, t);
        else {
          const e = n.Ne(r.kind);
          Yi.fe.Zt(t, e);
        }
  ...
  getFieldIndexes(t, e) {
    const n = _r(t),
      s = wr(t);
    return (
      e ? n.qt("collectionGroupIndex", IDBKeyRange.bound(e, e)) : n.qt()
    ).next((t) => {
      const e = [];
      return yi
        .forEach(t, (t) =>
              ...
              (function (t, e) {
                const n = e
                    ? new ue(
                        ...
                        new he(
                          Bi(e.readTime),
                          new xt(Ws(e.documentKey)),
                          e.largestBatchId
                        )
                      )
                    : ue.empty(),
                  s = t.fields.map(
                    ([t, e]) => new oe(mt.fromServerFormat(t), e)
                  );
  ...
  updateCollectionGroup(t, e, n) {
    const s = _r(t),
      i = wr(t);
    return this.rn(t).next((t) =>
      s.qt("collectionGroupIndex", IDBKeyRange.bound(e, e)).next((e) =>
        yi.forEach(e, (e) =>
          i.put(
            (function (t, e, n, s) {
              return {
  ...
  updateIndexEntries(t, e) {
    ...
    return yi.forEach(e, (e, s) => {
      ...
      return (
        i ? yi.resolve(i) : this.getFieldIndexes(t, e.collectionGroup)
      ).next(
        (i) => (
          n.set(e.collectionGroup, i),
          yi.forEach(i, (n) =>
            this.on(t, e, n).next((e) => {
              const i = this.un(s, n);
    ...
    if (null != i) {
      ...
      if (Gt(r))
        for (const i of r.arrayValue.values || [])
          n = n.add(new ir(e.indexId, t.key, this.Je(i), s));
  ...
  getMinOffset(t, e) {
    ...
    return yi
      .forEach(this.Qe(e), (e) =>
        this.je(t, e).next((t) => {
          t
            ? (!n || le(t.indexState.offset, n) < 0) &&
              (n = t.indexState.offset)
            : (n = he.min());
        })
      )
      .next(() => n);
...
class gr {
  ...
  static withCacheSize(t) {
    return new gr(
      t,
      gr.DEFAULT_COLLECTION_PERCENTILE,
      gr.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT
    );
  }
}
...
/** A mutation queue for a specific user, backed by IndexedDB. */ (gr.DEFAULT_COLLECTION_PERCENTILE = 10),
  (gr.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT = 1e3),
  (gr.DEFAULT = new gr(
    41943040,
    gr.DEFAULT_COLLECTION_PERCENTILE,
    gr.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT
...
class Ir {
  ...
  addMutationBatch(t, e, n, s) {
    ...
    return r.add({}).next((o) => {
      U("number" == typeof o);
      const u = new Di(o, e, n, s),
        a = (function (t, e, n) {
          const s = n.baseMutations.map((e) => vs(t.Jt, e)),
            i = n.mutations.map((e) => vs(t.Jt, e));
          return {
            userId: e,
            batchId: n.batchId,
  ...
  lookupMutationBatch(t, e) {
    return Er(t)
      .get(e)
      .next((t) => (t ? (U(t.userId === this.userId), Li(this.M, t)) : null));
  }
  /**
  ...
  getNextMutationBatchAfterBatchId(t, e) {
    ...
    return Er(t)
      .Wt(
        ...
        (t, e, s) => {
          e.userId === this.userId && (U(e.batchId >= n), (i = Li(this.M, e))),
            s.done();
        }
      )
      .next(() => i);
  ...
  getAllMutationBatches(t) {
    ...
    return Er(t)
      .qt("userMutationsIndex", e)
      .next((t) => t.map((t) => Li(this.M, t)));
  }
  getAllMutationBatchesAffectingDocumentKey(t, e) {
    // Scan the document-mutation index starting with a prefix starting with
    // the given documentKey.
    const n = Hs(this.userId, e.path),
        ...
        const i = Hs(this.userId, e.path),
          ...
          o = Ar(t).Wt(
            ...
            (t, s, i) => {
              ...
              // documents nested in a subcollection beneath documentKey so we
              // can stop as soon as we hit any such row.
              r === this.userId && e.path.isEqual(a)
                ? (n = n.add(u))
                : i.done();
            }
          );
  ...
  removeMutationBatch(t, e) {
    return yr(t.Ht, this.userId, e).next(
      (n) => (
        t.addOnCommittedListener(() => {
          this._n(e.batchId);
        }),
 ...
 */ class br {
  ...
  allocateTargetId(t) {
    return this.pn(t).next((e) => {
      ...
      return (
        ...
        this.In(t, e).next(() => e.highestTargetId)
      );
    });
  }
  getLastRemoteSnapshotVersion(t) {
    return this.pn(t).next((t) =>
      ct.fromTimestamp(
        new at(
  ...
  addTargetData(t, e) {
    return this.Tn(t, e).next(() =>
      this.pn(t).next(
        (n) => ((n.targetCount += 1), this.En(e, n), this.In(t, n))
      )
    );
  }
    ...
    return Vr(t)
      .Wt((r, o) => {
        ...
        u.sequenceNumber <= e &&
          ...
          (s++, i.push(this.removeTargetData(t, u)));
      })
      .next(() => yi.waitFor(i))
      .next(() => s);
  }
  ...
  containsKey(t, e) {
    const n = Gs(e.path),
      s = IDBKeyRange.bound([n], [ut(n)], /*lowerOpen=*/ !1, /*upperOpen=*/ !0);
    let i = 0;
    return Sr(t)
      .Wt(
        {
 ...
 */ class Nr {
  ...
  Sn(t) {
    ...
    O("LruGarbageCollector", `Garbage collection scheduled in ${e}ms`),
      (this.vn = this.asyncQueue.enqueueAfterDelay(
        "lru_garbage_collection" /* LruGarbageCollection */,
        e,
        async () => {
...
/** Implements the steps for LRU garbage collection. */ class kr {
  ...
  nthSequenceNumber(t, e) {
    ...
    const n = new xr(e);
    return this.Dn.forEachTarget(t, (t) => n.bn(t.sequenceNumber))
      .next(() => this.Dn.xn(t, (t) => n.bn(t)))
      .next(() => n.maxValue);
  }
  removeTargets(t, e, n) {
  ...
  Nn(t, e) {
    ...
    return this.calculateTargetCount(t, this.params.percentileToCollect)
      ...
      .next((s) => ((n = s), (o = Date.now()), this.removeTargets(t, n, e)))
      .next(
        (e) => ((i = e), (a = Date.now()), this.removeOrphanedDocuments(t, n))
      )
      .next((t) => {
...
class Mr {
   ...
   */ On(t, e) {
    return (function (t, e) {
      let n = !1;
      return Rr(t)
        .zt((s) => Tr(t, s, e).next((t) => (t && (n = !0), yi.resolve(!t))))
        .next(() => n);
    })(t, e);
  }
  removeOrphanedDocuments(t, e) {
          ...
          if (!e)
            ...
            return (
              ...
              n
                ...
                .next(
                  () => (
                    n.removeEntry(r, ct.min()), Sr(t).delete([0, Gs(r.path)])
                  )
                )
            );
        });
 ...
 */ class Fr {
   ...
   */ removeEntry(t, e) {
    this.assertNotApplied(),
      this.changes.set(t, ne.newInvalidDocument(t).setReadTime(e));
  }
  /**
 ...
 */ class $r {
  ...
  Ln(t, e, n) {
    ...
    const i = IDBKeyRange.bound(qr(s.first()), qr(s.last())),
      r = s.getIterator();
    let o = r.getNext();
    return Ur(t)
      .Wt(
...
class Br extends Fr {
  ...
  applyChanges(t) {
    const e = [];
    let n = 0,
      s = new we((t, e) => rt(t.canonicalString(), e.canonicalString()));
    return (
      this.changes.forEach((i, r) => {
        const o = this.Gn.get(i);
        if (
          (e.push(this.Kn.removeEntry(t, i, o.readTime)), r.isValidDocument())
        ) {
      ...
      e.push(this.Kn.updateMetadata(t, n)),
      yi.waitFor(e)
    );
  }
  getFromCache(t, e) {
    // Record the size of everything we load from the cache so we can compute a delta later.
    return this.Kn.Bn(t, e).next(
      (t) => (
        this.Gn.set(e, {
          size: t.size,
 ...
 */ function Gr(t, e) {
  ...
  for (let t = 0; t < n.length - 2 && t < s.length - 2; ++t)
    if (((i = rt(n[t], s[t])), i)) return i;
  return (
    (i = rt(n.length, s.length)),
    i ||
      ((i = rt(n[n.length - 2], s[s.length - 2])),
...
class Qr {
   ...
   */ kt(t, e, n, s) {
    ...
    return (
      ...
      n < 7 && s >= 7 && (r = r.next(() => this.Wn(i))),
      n < 8 && s >= 8 && (r = r.next(() => this.zn(t, i))),
      n < 9 &&
        s >= 9 &&
        (r = r.next(() => {
        ...
        (r = r
          .next(() =>
            (function (t) {
              ...
              e.createIndex("documentKeyIndex", Zs),
                e.createIndex("collectionGroupIndex", ti);
            })(t)
          )
          .next(() => this.Jn(t, i))
  ...
  Qn(t) {
    ...
    return e.qt().next((e) =>
      yi.forEach(e, (e) => {
        ...
        return n.qt("userMutationsIndex", s).next((n) =>
          yi.forEach(n, (n) => {
            U(n.userId === e.userId);
            const s = Li(this.M, n);
    ...
    return n
      .Wt((t, n) => {
        const i = e.store("remoteDocumentsV14"),
          r = ((o = n),
          o.document
            ? new xt(_t.fromString(o.document.name).popFirst(5))
            : o.noDocument
            ? xt.fromSegments(o.noDocument.path)
            : o.unknownDocument
            ? xt.fromSegments(o.unknownDocument.path)
            : L()).path.toArray();
        var o;
        /**
         * @license
...
class zr {
  constructor(
    ...
    (this.referenceDelegate = new Mr(this, s)),
      (this.hs = e + "main"),
      (this.M = new ki(u)),
      (this.ls = new Ii(this.hs, this.ts, new Qr(this.M))),
      (this.fs = new br(this.referenceDelegate, this.M)),
      (this.ds = (function (t) {
        return new $r(t);
      })(this.M)),
      (this._s = new ji()),
      this.window && this.window.localStorage
        ? (this.ws = this.window.localStorage)
        : ((this.ws = null),
          !1 === c &&
            F(
      ...
      .then(() => {
        ...
        return (
          ...
          this.runTransaction(
            ...
            "readonly",
            (t) => this.fs.getHighestSequenceNumber(t)
          )
        );
      })
      .then((t) => {
    ...
    return this.runTransaction(
      ...
      (t) =>
        Jr(t)
          ...
          .next(() => {
            if (this.isPrimary)
              return this.Es(t).next((t) => {
                t ||
                  ((this.isPrimary = !1),
                  this.Yn.enqueueRetryable(() => this.cs(!1)));
              });
          })
          .next(() => this.As(t))
          .next((e) =>
      ...
      .catch((t) => {
        if (Ai(t))
          ...
          return (
            O("IndexedDbPersistence", "Failed to extend owner lease: ", t),
            this.isPrimary
          );
   ...
   */ Is() {
    this.os = this.Yn.enqueueAfterDelay(
      "client_metadata_refresh" /* ClientMetadataRefresh */,
      4e3,
      () =>
        this.gs()
          .then(() => this.vs())
   ...
   */ As(t) {
    ...
    return Hr(t)
      ...
      .next((e) => {
        ...
        if (
          null !== e &&
          this.Ss(e.leaseTimestampMs, 5e3) &&
          !this.xs(e.ownerId)
        ) {
   ...
   */ Fs() {
    return this.runTransaction("getActiveClients", "readonly", (t) =>
      Jr(t)
        .qt()
        .next((t) => this.Ds(t, 18e5).map((t) => t.clientId))
    );
  }
  get started() {
    return this.ns;
  ...
  runTransaction(t, e, n) {
    ...
    return this.ls
      .runTransaction(
        ...
        i,
        (s) => (
          (o = new vi(s, this.es ? this.es.next() : nt.A)),
          "readwrite-primary" === e
            ? this.Es(o)
                .next((t) => !!t || this.As(o))
                .next((e) => {
                  if (!e)
                    throw (
                      (F(`Failed to obtain primary lease for action '${t}'.`),
                      (this.isPrimary = !1),
                      this.Yn.enqueueRetryable(() => this.cs(!1)),
                      new Q(G.FAILED_PRECONDITION, mi))
                    );
                  return n(o);
                })
  ...
  $s(t) {
    return Hr(t)
      ...
      .next((t) => {
        if (
          null !== t &&
          this.Ss(t.leaseTimestampMs, 5e3) &&
          !this.xs(t.ownerId) &&
          !this.bs(t) &&
          !(
            this.Zn ||
  ...
  /** Checks the primary lease and removes it if we are the current primary. */ Rs(
    t
  ) {
    const e = Hr(t);
    return e
      ...
      .next((t) =>
        this.bs(t)
          ? (O("IndexedDbPersistence", "Releasing primary lease."),
            e.delete("owner"))
          : yi.resolve()
      );
  }
  /** Verifies that `updateTimeMs` is within `maxAgeMs`. */ Ss(t, e) {
    ...
    return (
      !(t < n - e) &&
      (!(t > n) ||
        (F(`Detected an update time that is in the future: ${t} > ${n}`), !1))
    );
  }
  ys() {
    null !== this.document &&
      ...
      this.document.addEventListener("visibilitychange", this.rs),
      (this.inForeground = "visible" === this.document.visibilityState));
  }
  ks() {
    this.rs &&
      (this.document.removeEventListener("visibilitychange", this.rs),
      (this.rs = null));
  }
  /**
      ...
      ((this.ss = () => {
        ...
        this.Ns(),
          isSafari() &&
            ...
            this.Yn.enterRestrictedMode(/* purgeExistingTasks= */ !0),
          this.Yn.enqueueAndForget(() => this.shutdown());
      }),
      this.window.addEventListener("pagehide", this.ss));
  }
  Ms() {
    this.ss &&
      (this.window.removeEventListener("pagehide", this.ss), (this.ss = null));
  }
  /**
   ...
   */ xs(t) {
    ...
    try {
      ...
      return (
        F("IndexedDbPersistence", "Failed to get zombied client id.", t), !1
      );
    }
  }
  /**
...
class Xr {
   ...
   * state for it.
   */ Ls(t, e) {
    return this.Bs.getAllMutationBatchesAffectingDocumentKey(t, e).next((n) =>
      this.Us(t, e, n)
    );
  }
  /** Internal version of `getDocument` that allows reusing batches. */ Us(
    t,
    e,
    n
  ) {
   ...
   */ Gs(t, e) {
    return this.Bs.getAllMutationBatchesAffectingDocumentKeys(t, e).next((t) =>
      this.qs(e, t)
    );
  }
  /**
  ...
  Ws(t, e, n) {
    ...
    let i = Wn();
    return this.indexManager.getCollectionParents(t, s).next((r) =>
      yi
        .forEach(r, (r) => {
          const o = (function (t, e) {
            return new Ue(
  ...
  zs(t, e, n) {
    ...
    let s;
    return this.ds
      .getAllFromCollection(t, e.path, n)
      .next((n) => ((s = n), this.Bs.getAllMutationBatchesAffectingQuery(t, e)))
      .next((t) => {
        for (const e of t)
          for (const t of e.mutations) {
            ...
            null == i &&
              ...
              ((i = ne.newInvalidDocument(n)), (s = s.insert(n, i))),
              Vn(t, i, e.localWriteTime),
 ...
 */ class to {
  ...
  /** Returns all local documents matching the specified query. */ Qs(
    t,
    e,
    n,
    s
    ...
    return this.ti(t, e)
      .next((i) => i || this.ei(t, e, s, n))
      .next((n) => n || this.ni(t, e));
  }
  /**
   ...
   */ ei(t, e, n, s) {
    return Ge(e) || s.isEqual(ct.min())
      ? this.ni(t, e)
      : this.Zs.Ks(t, n).next((i) => {
          const r = this.si(e, i);
          return this.ii(e, r, n, s)
            ? this.ni(t, e)
            : (k() <= LogLevel.DEBUG &&
                O(
                  "QueryEngine",
  ...
  /** Applies the query filter and sorting to the provided documents.  */ si(
    t,
    e
  ) {
  ...
  ni(t, e) {
    return (
      k() <= LogLevel.DEBUG &&
        O("QueryEngine", "Using full collection scan to execute query:", Ze(e)),
...
class eo {
  constructor(
    ...
    (this.persistence = t),
       ...
       */
      (this.ci = new Map()),
      (this.hi = t.getRemoteDocumentCache()),
      (this.fs = t.getTargetCache()),
      (this._s = t.getBundleCache()),
      this.li(n);
  }
  li(t) {
    ...
    (this.indexManager = this.persistence.getIndexManager(t)),
      (this.Bs = this.persistence.getMutationQueue(t, this.indexManager)),
      (this.fi = new Xr(this.hi, this.Bs, this.indexManager)),
      this.hi.setIndexManager(this.indexManager),
...
async function so(t, e) {
  ...
  return await n.persistence.runTransaction(
    ...
    (t) => {
      ...
      // before and after.
      let s;
      return n.Bs.getAllMutationBatches(t)
        .next((i) => ((s = i), n.li(e), n.Bs.getAllMutationBatches(t)))
        .next((e) => {
          const i = [],
            r = [];
...
function ro(t) {
  ...
  return e.persistence.runTransaction(
    ...
    "readonly",
    (t) => e.fs.getLastRemoteSnapshotVersion(t)
  );
}
  ...
  return n.persistence
    .runTransaction("Apply remote event", "readwrite-primary", (t) => {
      ...
      e.targetChanges.forEach((r, u) => {
        ...
        o.push(
          n.fs
            .removeMatchingKeys(t, r.removedDocuments, u)
            .next(() => n.fs.addMatchingKeys(t, r.addedDocuments, u))
        );
        let c = a.withSequenceNumber(t.currentSequenceNumber);
        e.targetMismatches.has(u)
          ? (c = c
              .withResumeToken(pt.EMPTY_BYTE_STRING, ct.min())
              .withLastLimboFreeSnapshotVersion(ct.min()))
          : r.resumeToken.approximateByteSize() > 0 &&
            (c = c.withResumeToken(r.resumeToken, s)),
          (i = i.insert(u, c)),
          ...
          (function (t, e, n) {
            ...
            c,
            r
          ) && o.push(n.fs.updateTargetData(t, c));
      });
      let u = Qn();
      ...
      if (
        (e.documentUpdates.forEach((s) => {
          e.resolvedLimboDocuments.has(s) &&
            o.push(n.persistence.referenceDelegate.updateLimboDocument(t, s));
        }),
        // Each loop iteration only affects its "own" doc, so it's safe to get all the remote
        // documents in advance in a single call.
        o.push(
          uo(t, r, e.documentUpdates).next((t) => {
            u = t;
          })
        ),
        !s.isEqual(ct.min()))
        ...
        const e = n.fs
          .getLastRemoteSnapshotVersion(t)
          .next((e) => n.fs.setTargetsMetadata(t, t.currentSequenceNumber, s));
        o.push(e);
      }
      return yi
        .waitFor(o)
        ...
        n.forEach((n, i) => {
          ...
          i.isNoDocument() && i.version.isEqual(ct.min())
            ? // NoDocuments with SnapshotVersion.min() are used in manufactured
              ...
              // access.
              (e.removeEntry(n, i.readTime), (s = s.insert(n, i)))
            : !r.isValidDocument() ||
              i.version.compareTo(r.version) > 0 ||
              (0 === i.version.compareTo(r.version) && r.hasPendingWrites)
...
function ao(t, e) {
  ...
  return n.persistence.runTransaction(
    ...
    "readonly",
    (t) => (
      void 0 === e && (e = -1), n.Bs.getNextMutationBatchAfterBatchId(t, e)
    )
  );
}
...
function co(t, e) {
  ...
  return n.persistence
    .runTransaction("Allocate target", "readwrite", (t) => {
      let s;
      return n.fs.getTargetData(t, e).next((i) =>
        i
          ...
          : n.fs
              ...
              .next(
                (i) => (
                  (s = new Ni(e, i, 0 /* Listen */, t.currentSequenceNumber)),
    ...
    .then((t) => {
      ...
      return (
        (null === s || t.snapshotVersion.compareTo(s.snapshotVersion) > 0) &&
          ((n.ui = n.ui.insert(t.targetId, t)), n.ai.set(e, t.targetId)),
        t
      );
    });
}
...
async function ho(t, e, n) {
  ...
  try {
    n ||
      (await s.persistence.runTransaction("Release target", r, (t) =>
        s.persistence.referenceDelegate.removeTarget(t, i)
      ));
  } catch (t) {
    if (!Ai(t)) throw t;
      ...
      .next((e) => {
        if (e)
          return (
            ...
            s.fs.getMatchingKeysForTargetId(t, e.targetId).next((t) => {
              r = t;
            })
          );
      })
      .next(() => s.oi.Qs(t, e, n ? i : ct.min(), n ? r : Yn()))
      .next(
        (t) => (
          wo(s, en(e), t),
          {
...
function fo(t, e) {
  ...
  return i
    ...
    : n.persistence.runTransaction("Get target data", "readonly", (t) =>
        s.Et(t, e).next((t) => (t ? t.target : null))
      );
}
...
function _o(t, e) {
  ...
  return n.persistence
    .runTransaction("Get new document changes", "readonly", (t) =>
      n.hi.getAllFromCollectionGroup(
        t,
        e,
        ae(s, -1),
  ...
  return i.persistence.runTransaction(
    ...
    (t) =>
      uo(t, u, o)
        ...
        .next((e) =>
          i.fs
            .removeMatchingKeysForTargetId(t, a.targetId)
            .next(() => i.fs.addMatchingKeys(t, r, a.targetId))
            .next(() => i.fi.Gs(t, e))
            .next(() => e)
        )
  );
...
async function go(t, e, n = Yn()) {
  ...
  const s = await co(t, He(Ki(e.bundledQuery))),
    i = K(t);
  return i.persistence.runTransaction("Save named query", "readwrite", (t) => {
    ...
    return (
      (i.ui = i.ui.insert(o.targetId, o)),
      i.fs
        .updateTargetData(t, o)
        .next(() => i.fs.removeMatchingKeysForTargetId(t, s.targetId))
 ...
 */ class po {
  ...
  getOverlaysForCollectionGroup(t, e, n, s) {
    ...
    for (; r.hasNext(); ) {
      ...
      if (t.getKey().getCollectionGroup() === e && t.largestBatchId > n) {
        ...
        null === e && ((e = zn()), (i = i.insert(t.largestBatchId, e))),
          e.set(t.getKey(), t);
      }
    }
    const o = zn(),
      u = i.getIterator();
    for (; u.hasNext(); ) {
      if ((u.getNext().value.forEach((t, e) => o.set(t, e)), o.size() >= s))
        break;
    }
    return yi.resolve(o);
  }
  Xt(t, e, n) {
    ...
    let i = this.Ii.get(e);
    void 0 === i && ((i = Yn()), this.Ii.set(e, i)),
      this.Ii.set(e, i.add(n.key));
  }
}
 ...
 */ class Io {
  ...
  /** Add references to the given document keys for the given ID. */ Pi(t, e) {
   ...
   */ vi(t) {
    const e = new xt(new _t([])),
      ...
      i = [];
    return (
      this.Ai.forEachInRange([n, s], (t) => {
        this.bi(t), i.push(t.key);
      }),
      i
    );
  }
  Si() {
    this.Ti.forEach((t) => this.bi(t));
  }
  bi(t) {
 ...
 */ class Eo {
  ...
  addMutationBatch(t, e, n, s) {
    ...
    for (const e of s)
      (this.Ni = this.Ni.add(new To(e.key, i))),
...
class Ao {
  ...
  getEntries(t, e) {
    ...
    return (
      e.forEach((t) => {
        ...
        n = n.insert(
          t,
          e ? e.document.mutableCopy() : ne.newInvalidDocument(t)
        );
      }),
      yi.resolve(n)
    );
  ...
  getAllFromCollection(t, e, n) {
    ...
    for (; r.hasNext(); ) {
      ...
      t.path.length > e.length + 1 ||
        le(ce(i), n) <= 0 ||
        (s = s.insert(i.key, i.mutableCopy()));
    }
    return yi.resolve(s);
  }
  getAllFromCollectionGroup(t, e, n, s) {
  ...
  applyChanges(t) {
    ...
    return (
      this.changes.forEach((n, s) => {
        s.isValidDocument()
          ? e.push(this.Kn.addEntry(t, s))
          : this.Kn.removeEntry(n);
      }),
      yi.waitFor(e)
    );
  }
 ...
 */ class Po {
  ...
  allocateTargetId(t) {
    return (
      (this.highestTargetId = this.Ki.next()), yi.resolve(this.highestTargetId)
    );
  }
  setTargetsMetadata(t, e, n) {
    return (
  ...
  Tn(t) {
    ...
    e > this.highestTargetId &&
      ((this.Ki = new Pr(e)), (this.highestTargetId = e)),
      t.sequenceNumber > this.Ui && (this.Ui = t.sequenceNumber);
  }
  addTargetData(t, e) {
  ...
  removeTargetData(t, e) {
    return (
      this.Li.delete(e.target),
      this.qi.vi(e.targetId),
      (this.targetCount -= 1),
      yi.resolve()
    );
  }
    ...
    return (
      this.Li.forEach((r, o) => {
        o.sequenceNumber <= e &&
          ...
          (this.Li.delete(r),
          i.push(this.removeMatchingKeysForTargetId(t, o.targetId)),
          s++);
      }),
      yi.waitFor(i).next(() => s)
    );
  ...
  addMatchingKeys(t, e, n) {
    return this.qi.Pi(e, n), yi.resolve();
  }
  removeMatchingKeys(t, e, n) {
    this.qi.Vi(e, n);
...
class bo {
  ...
  constructor(t, e) {
    (this.Gi = {}),
      ...
      (this.fs = new Po(this));
    (this.indexManager = new ar()),
      (this.ds = (function (t) {
        return new Ao(t);
      })((t) => this.referenceDelegate.Qi(t))),
      (this.M = new ki(e)),
      (this._s = new yo(this.M));
  }
  start() {
  ...
  getMutationQueue(t, e) {
    ...
    return (
      n || ((n = new Eo(e, this.referenceDelegate)), (this.Gi[t.toKey()] = n)),
      n
    );
  }
  getTargetCache() {
  ...
  runTransaction(t, e, n) {
    ...
    return (
      this.referenceDelegate.ji(),
      n(s)
        .next((t) => this.referenceDelegate.Wi(s).next(() => t))
        .toPromise()
...
class vo {
  ...
  addReference(t, e, n) {
    return (
      this.Hi.addReference(n, e), this.Xi.delete(n.toString()), yi.resolve()
    );
  }
  removeReference(t, e, n) {
    return (
      this.Hi.removeReference(n, e), this.Xi.add(n.toString()), yi.resolve()
    );
  }
  markPotentiallyOrphaned(t, e) {
  ...
  Zi(t, e) {
    return yi.or([
      () => yi.resolve(this.Hi.containsKey(e)),
      () => this.persistence.getTargetCache().containsKey(t, e),
      () => this.persistence.zi(t, e),
    ]);
  }
}
   ...
   */ static tr(t, e, n) {
    ...
    return (
      r &&
        ...
        r && (i = new Q(s.error.code, s.error.message))),
      r
        ? new xo(t, e, s.state, i)
        : (F(
            "SharedClientState",
   ...
   */ static tr(t, e) {
    ...
    return (
      i &&
        ...
        i && (s = new Q(n.error.code, n.error.message))),
      i
        ? new No(t, n.state, s)
        : (F(
            "SharedClientState",
 ...
 */ class ko {
   ...
   */ static tr(t, e) {
    ...
    for (let t = 0; s && t < n.activeTargetIds.length; ++t)
      (s = Ct(n.activeTargetIds[t])), (i = i.add(n.activeTargetIds[t]));
    return s
      ? new ko(t, i)
      : (F(
          "SharedClientState",
 ...
 */ class Mo {
   ...
   */ static tr(t) {
    ...
    return "object" == typeof e &&
      ...
      ? new Mo(e.clientId, e.onlineState)
      : (F("SharedClientState", `Failed to parse online state: ${t}`), null);
  }
}
 ...
 */ class Fo {
  constructor(t, e, n, s, i) {
    ...
    (this.storage = this.window.localStorage),
      (this.currentUser = i),
      (this.hr = So(this.persistenceKey, this.ir)),
      (this.lr =
      ...
      (this.ar = this.ar.insert(this.ir, new Oo())),
      (this.dr = new RegExp(`^firestore_clients_${r}_([^_]*)$`)),
      (this._r = new RegExp(`^firestore_mutations_${r}_(\\d+)(?:_(.*))?$`)),
      (this.wr = new RegExp(`^firestore_targets_${r}_(\\d+)$`)),
      (this.mr =
  ...
  /** Returns 'true' if WebStorage is available in the current environment. */ static vt(
    t
  ) {
  ...
  shutdown() {
    this.started &&
      (this.window.removeEventListener("storage", this.rr),
      this.removeItem(this.hr),
      (this.started = !1));
  }
  getItem(t) {
  ...
  ur(t) {
    ...
    if (e.storageArea === this.storage) {
      if (
        (O("SharedClientState", "EVENT", e.key, e.newValue), e.key === this.hr)
      )
        return void F(
  ...
  Er(t, e, n) {
    const s = new xo(this.currentUser, t, e, n),
  ...
  Pr(t, e, n) {
    const s = Co(this.persistenceKey, t),
      i = new No(t, e, n);
    this.setItem(s, i.er());
  }
  Vr(t) {
  ...
  async Nr(t) {
    if (t.user.uid === this.currentUser.uid)
      return this.syncEngine.$r(t.batchId, t.state, t.error);
    O(
      "SharedClientState",
  ...
  Sr(t, e) {
    const n = e ? this.ar.insert(t, e) : this.ar.remove(t),
      s = this.Tr(this.ar),
      i = this.Tr(n),
      r = [],
      o = [];
...
class Lo {
  ...
  shutdown() {
    window.removeEventListener("online", this.Gr),
      window.removeEventListener("offline", this.jr);
  }
  Hr() {
    window.addEventListener("online", this.Gr),
      window.addEventListener("offline", this.jr);
  }
  Qr() {
 ...
 */ class Ko
  ...
  extends class {
    ...
    co(t, e, n, s, i) {
      ...
      return (
        this.lo(o, s, i),
        this.fo(t, r, o, n).then(
          (t) => (O("RestConnection", "Received: ", t), t),
          (e) => {
            throw (
              ($(
                "RestConnection",
  ...
  }
{
        ...
        try {
          switch (o.getLastErrorCode()) {
            ...
            case ErrorCode.TIMEOUT:
              O("Connection", 'RPC "' + t + '" timed out'),
                r(new Q(G.DEADLINE_EXCEEDED, "Request time out"));
              break;
            ...
            case ErrorCode.HTTP_ERROR:
              ...
              else r(new Q(G.UNAVAILABLE, "Connection failed."));
              break;
  ...
  wo(t, e, n) {
    ...
    this.useFetchStreams && (o.xmlHttpFactory = new FetchXmlHttpFactory({})),
    ...
    const l = new qo({
        Jr: (t) => {
          h
            ? O("Connection", "Not sending because WebChannel is closed:", t)
            : (c ||
                (O("Connection", "Opening WebChannel transport."),
                a.open(),
                (c = !0)),
              O("Connection", "WebChannel sending:", t),
              a.send(t));
        },
        Yr: () => a.close(),
      }),
    ...
    return (
      ...
      y(a, WebChannel.EventType.ERROR, (t) => {
        h ||
          ...
          l.ro(new Q(G.UNAVAILABLE, "The operation could not be completed")));
      }),
      y(a, WebChannel.EventType.MESSAGE, (t) => {
        ...
        if (!h) {
          ...
          const s = n,
            i =
              s.error ||
              (null === (e = s[0]) || void 0 === e ? void 0 : e.error);
          if (i) {
            ...
            void 0 === e &&
              ((e = G.INTERNAL),
              (n =
                "Unknown error status: " + t + " with message " + i.message)),
      ...
      y(r, Event.STAT_EVENT, (t) => {
        t.stat === Stat.PROXY
          ? O("Connection", "Detected buffering proxy")
          : t.stat === Stat.NOPROXY &&
            O("Connection", "Detected no buffering proxy");
      }),
      setTimeout(() => {
...
class Wo {
   ...
   */ Ro(t) {
    ...
    // honored as such).
    const e = Math.floor(this.Io + this.Po()),
    ...
    s > 0 &&
      ...
      (this.To = this.Yn.enqueueAfterDelay(
        this.timerId,
        s,
        () => ((this.Eo = Date.now()), t())
      )),
...
class zo {
   ...
   */ ko() {
    return (
      1 /* Starting */ === this.state ||
      5 /* Backoff */ === this.state ||
      this.Mo()
    );
  }
  /**
   ...
   */ $o() {
    ...
    this.Mo() &&
      null === this.Co &&
      (this.Co = this.Yn.enqueueAfterDelay(this.Vo, 6e4, () => this.Bo()));
  }
    ...
    this.Uo(),
      ...
      4 /* Error */ !== t
        ? // If this is an intentional close ensure we don't delay our next connection attempt.
          this.No.reset()
        : e && e.code === G.RESOURCE_EXHAUSTED
        ? // Log the error. (Probably either 'quota exceeded' or 'max queue length reached'.)
          (F(e.toString()),
          F("Using maximum backoff delay to prevent overloading the backend."),
          this.No.Ao())
        : e &&
          e.code === G.UNAUTHENTICATED &&
          3 /* Healthy */ !== this.state &&
      ...
      null !== this.stream &&
        (this.Ko(), this.stream.close(), (this.stream = null)),
  ...
  Qo(t, e) {
    ...
    (this.stream = this.Wo(t, e)),
      this.stream.Xr(() => {
        n(
          () => (
            (this.state = 2) /* Open */,
            (this.xo = this.Yn.enqueueAfterDelay(
              this.vo,
              1e4,
              () => (
                this.Mo() && (this.state = 3) /* Healthy */, Promise.resolve()
              )
            )),
            this.listener.Xr()
          )
  ...
  jo(t) {
    ...
    return (
      O("PersistentStream", `close with error: ${t}`),
      (this.stream = null),
      this.close(4 /* Error */, t)
    );
  }
  /**
 ...
 */ class Ho extends zo {
  constructor(t, e, n, s, i, r) {
    super(
      t,
      "listen_stream_connection_backoff" /* ListenStreamConnectionBackoff */,
      ...
      (e.addTarget = (function (t, e) {
        ...
        return (
          ...
          e.resumeToken.approximateByteSize() > 0
            ? (n.resumeToken = ds(t, e.resumeToken))
            : e.snapshotVersion.compareTo(ct.min()) > 0 &&
              // TODO(wuandy): Consider removing above check because it is most likely true.
              // Right now, many tests depend on this behaviour though (leaving min() out
              // of serialization).
              (n.readTime = fs(t, e.snapshotVersion.toTimestamp())),
          n
        );
      })(this.M, t));
    const n = ks(this.M, t);
 ...
 */ class Jo extends zo {
  constructor(t, e, n, s, i, r) {
    super(
      t,
      "write_stream_connection_backoff" /* WriteStreamConnectionBackoff */,
  ...
  onMessage(t) {
    if (
      ...
      this.No.reset();
      const e = Ds(t.writeResults, t.commitTime),
        n = ws(t.commitTime);
      return this.listener.tu(n, e);
    }
    // The first response is always the handshake response
    return (
      U(!t.writeResults || 0 === t.writeResults.length),
      (this.Yo = !0),
      this.listener.eu()
    );
  }
  ...
  /** Invokes the provided RPC with auth and AppCheck tokens. */ co(t, e, n) {
    return (
      ...
      Promise.all([
        ...
        .then(([s, i]) => this.So.co(t, e, n, s, i))
        .catch((t) => {
          throw "FirebaseError" === t.name
            ? (t.code === G.UNAUTHENTICATED &&
                (this.authCredentials.invalidateToken(),
                this.appCheckCredentials.invalidateToken()),
              t)
            : new Q(G.UNKNOWN, t.toString());
        })
    );
  }
  /** Invokes the provided RPC with streamed results with auth and AppCheck tokens. */ _o(
    t,
    e,
    n
  ) {
...
class Xo {
   ...
   */ au() {
    0 === this.ru &&
      (this.cu("Unknown" /* Unknown */),
      (this.ou = this.asyncQueue.enqueueAfterDelay(
        "online_state_timeout" /* OnlineStateTimeout */,
        1e4,
        () => (
          (this.ou = null),
          this.hu("Backend didn't respond within 10 seconds."),
        ...
        n.enqueueAndForget(async () => {
          ...
          au(this) &&
            ...
            await (async function (t) {
              const e = K(t);
              e.wu.add(4 /* ConnectivityChange */),
                await eu(e),
                e.yu.set("Unknown" /* Unknown */),
                e.wu.delete(4 /* ConnectivityChange */),
                await tu(e);
            })(this));
        });
      }),
 ...
 */ function uu(t) {
  return au(t) && !bu(t).ko() && t._u.size > 0;
}
...
async function fu(t, e, n) {
  if (
    ...
    (t.yu.set("Online" /* Online */),
    e instanceof is && 2 /* Removed */ === e.state && e.cause)
  )
    ...
    (e instanceof ns ? t.pu.ut(e) : e instanceof ss ? t.pu._t(e) : t.pu.ht(e),
    !n.isEqual(ct.min()))
  )
    try {
        ...
        (function (t, e) {
          ...
          return (
            ...
            n.targetMismatches.forEach((e) => {
              ...
              t._u.set(
                e,
                n.withResumeToken(pt.EMPTY_BYTE_STRING, n.snapshotVersion)
              ),
  ...
  e &&
    ...
    (await (async function (t, e) {
      ...
      if (((n = e.code), Un(n) && n !== G.ABORTED)) {
        ...
        // restart.
        Vu(t).Fo(),
          await _u(t, () => t.remoteSyncer.rejectFailedWrite(n.batchId, e)),
...
async function Ru(t, e) {
  ...
  n.wu.add(3 /* CredentialChange */),
    await eu(n),
    s &&
      // Don't set the network status to Unknown if we are offline.
      n.yu.set("Unknown" /* Unknown */),
    await n.remoteSyncer.handleCredentialChange(e),
    n.wu.delete(3 /* CredentialChange */),
    await tu(n);
}
 ...
 */ async function Pu(t, e) {
  const n = K(t);
  e
    ? (n.wu.delete(2 /* IsSecondary */), await tu(n))
    : e ||
      (n.wu.add(2 /* IsSecondary */),
      await eu(n),
      n.yu.set("Unknown" /* Unknown */));
}
  ...
  return (
    t.Iu ||
      ...
      ((t.Iu = (function (t, e, n) {
        ...
        return (
          s.iu(),
          new Ho(e, s.So, s.authCredentials, s.appCheckCredentials, s.M, n)
        );
      })(
        /**
         * @license
      ...
      t.mu.push(async (e) => {
        e
          ? (t.Iu.Fo(), uu(t) ? ou(t) : t.yu.set("Unknown" /* Unknown */))
          : (await t.Iu.stop(), cu(t));
      })),
    t.Iu
  );
}
  ...
  return (
    t.Tu ||
      ...
      ((t.Tu = (function (t, e, n) {
        ...
        return (
          s.iu(),
          new Jo(e, s.So, s.authCredentials, s.appCheckCredentials, s.M, n)
        );
        ...
        e
          ...
          : (await t.Tu.stop(),
            t.du.length > 0 &&
              (O(
                "RemoteStore",
                `Stopping write stream with ${t.du.length} pending writes`
              ),
              (t.du = [])));
      })),
    t.Tu
   ...
   */ cancel(t) {
    null !== this.timerHandle &&
      ...
      this.deferred.reject(
        new Q(G.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))
      ));
  }
  handleDelayElapsed() {
 ...
 */ class Du {
  ...
  constructor(t) {
    ...
    (this.comparator = t
      ? (e, n) => t(e, n) || xt.comparator(e.key, n.key)
  ...
  track(t) {
    ...
    n
      ? // Merge the new change with the existing change.
        0 /* Added */ !== t.type && 3 /* Metadata */ === n.type
        ? (this.Eu = this.Eu.insert(e, t))
        : 3 /* Metadata */ === t.type && 1 /* Removed */ !== n.type
        ? (this.Eu = this.Eu.insert(e, {
            type: n.type,
            doc: t.doc,
          }))
        : 2 /* Modified */ === t.type && 2 /* Modified */ === n.type
        ? (this.Eu = this.Eu.insert(e, {
            type: 2 /* Modified */,
            doc: t.doc,
          }))
        : 2 /* Modified */ === t.type && 0 /* Added */ === n.type
        ? (this.Eu = this.Eu.insert(e, {
            type: 0 /* Added */,
            doc: t.doc,
          }))
        : 1 /* Removed */ === t.type && 0 /* Added */ === n.type
        ? (this.Eu = this.Eu.remove(e))
        : 1 /* Removed */ === t.type && 2 /* Modified */ === n.type
        ? (this.Eu = this.Eu.insert(e, {
            type: 1 /* Removed */,
            doc: n.doc,
          }))
        : 0 /* Added */ === t.type && 1 /* Removed */ === n.type
        ? (this.Eu = this.Eu.insert(e, {
            type: 2 /* Modified */,
            doc: t.doc,
          }))
...
class xu {
  ...
  /** Returns a view snapshot as if all documents in the snapshot were added. */ static fromInitialDocuments(
    t,
    e,
    n,
    s
 ...
 */ class Lu {
   ...
   */ Vu(t) {
    ...
    return (
      this.Su
        ? this.Cu(t) && (this.vu.next(t), (e = !0))
        : this.xu(t, this.onlineState) && (this.Nu(t), (e = !0)),
      (this.Du = t),
      e
    );
  }
  ...
  xu(t, e) {
    ...
    return (
      (!this.options.ku || !n) &&
      (!t.docs.isEmpty() || "Offline" /* Offline */ === e)
    );
  ...
  Cu(t) {
    ...
    return (
      !(!t.syncStateChanged && !e) && !0 === this.options.includeMetadataChanges
    );
  ...
  Nu(t) {
    (t = xu.fromInitialDocuments(t.query, t.docs, t.mutatedKeys, t.fromCache)),
      (this.Su = !0),
      this.vu.next(t);
  }
}
 ...
 */ class qu {
   ...
   */ mi(t) {
    return t.metadata.exists
      ? Ps(this.M, t.document, !1)
      : ne.newNoDocument(
          this.wi(t.metadata.name),
          this.gi(t.metadata.readTime)
        );
  }
  gi(t) {
    return ws(t);
 ...
 */ class Ku {
   ...
   */ Fu(t) {
    ...
    return e !== this.progress.documentsLoaded
      ? ((this.progress.documentsLoaded = e), Object.assign({}, this.progress))
      : null;
  }
  $u(t) {
    const e = new Map(),
 ...
 */ class Wu {
   ...
   */ Wu(t, e) {
    ...
    const u =
        "F" /* First */ === this.query.limitType && s.size === this.query.limit
          ? s.last()
          : null,
      a =
        "L" /* Last */ === this.query.limitType && s.size === this.query.limit
          ? s.first()
          : null;
    ...
    if (
      (t.inorderTraversal((t, e) => {
        ...
        if (c && h) {
          c.data.isEqual(h.data)
            ...
            : this.Hu(c, h) ||
              ...
              (d = !0),
              ((u && this.Gu(h, u) > 0) || (a && this.Gu(h, a) < 0)) &&
        ...
        d &&
          (h
            ? ((r = r.add(h)), (i = f ? i.add(t) : i.delete(t)))
            : ((r = r.delete(t)), (i = i.delete(t))));
      }),
      null !== this.query.limit)
    )
      for (; r.size > this.query.limit; ) {
        const t =
          "F" /* First */ === this.query.limitType ? r.last() : r.first();
        (r = r.delete(t.key)),
          (i = i.delete(t.key)),
          n.track({
            type: 1 /* Removed */,
  ...
  applyChanges(t, e, n) {
    ...
    i.sort(
      ...
      this.Ju(n);
    const r = e ? this.Yu() : [],
      o = 0 === this.Ku.size && this.current ? 1 /* Synced */ : 0 /* Local */,
      u = o !== this.qu;
   ...
   */ Ju(t) {
    t &&
      (t.addedDocuments.forEach((t) => (this.Uu = this.Uu.add(t))),
      t.modifiedDocuments.forEach((t) => {}),
      t.removedDocuments.forEach((t) => (this.Uu = this.Uu.delete(t))),
  ...
  // PORTING NOTE: Multi-tab only.
  ea() {
    return xu.fromInitialDocuments(
      this.query,
      this.Qu,
      this.mutatedKeys,
      0 /* Local */ === this.qu
 ...
 */ async function Xu(t, e, n, s) {
  ...
  t._a = (e, n, s) =>
    (async function (t, e, n, s) {
      ...
      i.ii &&
        ...
        (i = await lo(t.localStore, e.query, /* usePreviousResults= */ !1).then(
          ({ documents: t }) => e.view.Wu(t, i)
        ));
      const r = s && s.targetChanges.get(e.targetId),
        o = e.view.applyChanges(
          i,
  ...
  const i = await lo(t.localStore, e, /* usePreviousResults= */ !0),
    r = new Wu(e, i._i),
    o = r.Wu(i.documents),
    u = es.createSynthesizedTargetChangeForCurrentChange(
      n,
      s && "Offline" /* Offline */ !== t.onlineState
    ),
    a = r.applyChanges(o, /* updateLimboDocuments= */ t.isPrimaryClient, u);
  la(t, n, a.Xu);
  const c = new zu(e, n, r);
  return (
    t.ia.set(e, c),
    t.ra.has(n) ? t.ra.get(n).push(e) : t.ra.set(n, [e]),
    a.snapshot
  );
}
...
/** Stops listening to the query. */ async function Zu(t, e) {
  ...
  if (n.isPrimaryClient) {
    ...
    n.sharedClientState.isActiveQueryTarget(s.targetId) ||
      (await ho(n.localStore, s.targetId, /*keepPersistedTargetData=*/ !1)
        .then(() => {
          n.sharedClientState.clearQueryState(s.targetId),
            su(n.remoteStore, s.targetId),
            ca(n, s.targetId);
        })
        .catch(Dr));
  } else
    ca(n, s.targetId),
      await ho(n.localStore, s.targetId, /*keepPersistedTargetData=*/ !0);
}
 ...
 */ async function ta(t, e, n) {
  ...
  try {
    ...
    s.sharedClientState.addPendingMutation(t.batchId),
      ...
      await _a(s, t.changes),
      await wu(s.remoteStore);
  } catch (t) {
    ...
    e.targetChanges.forEach((t, e) => {
      ...
      s &&
        ...
        t.addedDocuments.size > 0
          ...
          ? U(s.na)
          : t.removedDocuments.size > 0 && (U(s.na), (s.na = !1)));
    }),
      await _a(n, t, e);
  } catch (t) {
    await Dr(t);
 ...
 */ function na(t, e, n) {
  ...
  // SharedClientState.
  if (
    (s.isPrimaryClient && 0 /* RemoteStore */ === n) ||
    (!s.isPrimaryClient && 1 /* SharedClientState */ === n)
  ) {
    const t = [];
    s.ia.forEach((n, s) => {
      const i = s.view.bu(e);
 ...
 */ async function sa(t, e, n) {
  ...
  if (r) {
    ...
    await ho(s.localStore, e, /* keepPersistedTargetData */ !1)
      .then(() => ca(s, e, n))
      .catch(Dr);
}
  ...
  try {
    const t = await (function (t, e) {
      ...
      return n.persistence.runTransaction(
        ...
        (t) => {
          let s;
          return n.Bs.lookupMutationBatch(t, e)
            .next(
              (e) => (
                U(null !== e), (s = e.keys()), n.Bs.removeMutationBatch(t, e)
              )
            )
            .next(() => n.Bs.performConsistencyCheck(t))
            .next(() => n.fi.Ks(t, s));
  ...
  try {
    const t = await (function (t) {
      ...
      return e.persistence.runTransaction(
        ...
        "readonly",
        (t) => e.Bs.getHighestUnacknowledgedBatchId(t)
      );
    })(n.localStore);
    if (-1 === t)
...
/** Reject all outstanding callbacks waiting for pending writes to complete. */ function aa(
  t,
  e,
  n
) {
  ...
  if (i) {
    const t = i.get(e);
    t && (n ? t.reject(n) : t.resolve(), (i = i.remove(e))),
      (s.ha[s.currentUser.toKey()] = i);
  }
}
...
function ha(t, e) {
  ...
  const n = t.ua.get(e);
  null !== n &&
    (su(t.remoteStore, n), (t.ua = t.ua.remove(e)), t.aa.delete(n), da(t));
}

function la(t, e, n) {
  for (const s of n)
    if (s instanceof Qu) t.ca.addReference(s.key, e), fa(t, s);
    else if (s instanceof ju) {
      O("SyncEngine", "Document no longer in limbo: " + s.key),
        t.ca.removeReference(s.key, e);
...
function fa(t, e) {
  ...
  t.ua.get(n) ||
    t.oa.has(s) ||
    (O("SyncEngine", "New document in limbo: " + n), t.oa.add(s), da(t));
}
 ...
 */ function da(t) {
  for (; t.oa.size > 0 && t.ua.size < t.maxConcurrentLimboResolutions; ) {
    ...
    const n = new xt(_t.fromString(e)),
      s = t.fa.next();
    t.aa.set(s, new Hu(n)),
      (t.ua = t.ua.insert(n, s)),
      nu(
        t.remoteStore,
        new Ni(He(Ke(n.path)), s, 2 /* LimboResolution */, nt.A)
      );
  }
}
    ...
    await (async function (t, e) {
        ...
        await n.persistence.runTransaction(
          ...
          (t) =>
            yi.forEach(e, (e) =>
              yi
                .forEach(e.Hs, (s) =>
                  n.persistence.referenceDelegate.addReference(t, e.targetId, s)
                )
                .next(() =>
                  yi.forEach(e.Js, (s) =>
      ...
      for (const t of e) {
        ...
        if (!t.fromCache) {
          const t = n.ui.get(e),
            s = t.snapshotVersion,
            i = t.withLastLimboFreeSnapshotVersion(s);
 ...
 */ async function ga(t, e) {
  const n = K(t),
    s = await lo(n.localStore, e.query, /* usePreviousResults= */ !0),
    i = e.view.ta(s);
  ...
  const i = K(t),
    r = await (function (t, e) {
      ...
      return n.persistence.runTransaction(
        ...
        "readonly",
        (t) => s.fn(t, e).next((e) => (e ? n.fi.Ks(t, e) : yi.resolve(null)))
      );
    })(
      // PORTING NOTE: Multi-Tab only.
      i.localStore,
...
async function Ia(t, e) {
  ...
  if ((ba(n), Va(n), !0 === e && !0 !== n.da)) {
    ...
    const t = n.sharedClientState.getAllActiveQueryTargets(),
      e = await Ta(n, t.toArray());
    (n.da = !0), await Pu(n.remoteStore, !0);
    ...
    n.ra.forEach((s, i) => {
      n.sharedClientState.isLocalQueryTarget(i)
        ...
        : (e = e.then(
            () => (
              ca(n, i), ho(n.localStore, i, /*keepPersistedTargetData=*/ !0)
            )
          )),
        su(n.remoteStore, i);
    }),
...
async function Ta(t, e, n) {
  ...
  for (const t of e) {
    ...
    if (n && 0 !== n.length) {
      ...
      (e = await co(s.localStore, n)), await Xu(s, Ea(n), t, /*current=*/ !1);
    }
    i.push(e);
  }
  return s.sa.zo(r), i;
...
async function Ra(t, e, n, s) {
  ...
  if (r && r.length > 0)
    switch (n) {
      case "current":
      case "not-current": {
        const t = await _o(i.localStore, en(r[0])),
          s = ts.createSynthesizedRemoteEventForCurrentChange(
            e,
            "current" === n
          );
        await _a(i, t, s);
      ...
      case "rejected":
        await ho(i.localStore, e, /* keepPersistedTargetData */ !0),
          ca(i, e, s);
        break;
...
/** Adds or removes Watch targets for queries from different tabs. */ async function Pa(
  t,
  e,
  n
) {
  ...
  if (s.da) {
    for (const t of e) {
      ...
      const e = await fo(s.localStore, t),
        n = await co(s.localStore, e);
      await Xu(s, Ea(e), n.targetId, /*current=*/ !1), nu(s.remoteStore, n);
    }
    ...
    for (const t of n)
      s.ra.has(t) &&
        ...
        (await ho(s.localStore, t, /* keepPersistedTargetData */ !1)
          .then(() => {
...
function ba(t) {
  const e = K(t);
  return (
    (e.remoteStore.remoteSyncer.applyRemoteEvent = ea.bind(null, e)),
    (e.remoteStore.remoteSyncer.getRemoteKeysForTarget = ma.bind(null, e)),
    (e.remoteStore.remoteSyncer.rejectListen = sa.bind(null, e)),
    (e.sa.zo = Fu.bind(null, e.eventManager)),
    (e.sa.wa = $u.bind(null, e.eventManager)),
    e
  );
}
...
function Va(t) {
  const e = K(t);
  return (
    (e.remoteStore.remoteSyncer.applySuccessfulWrite = ia.bind(null, e)),
    (e.remoteStore.remoteSyncer.rejectFailedWrite = ra.bind(null, e)),
    e
  );
}
 ...
 */ function va(t, e, n) {
  ...
  (async function (t, e, n) {
    try {
      ...
      if (
        await (function (t, e) {
          const n = K(t),
            s = ws(e.createTime);
          return n.persistence
            .runTransaction("hasNewerBundle", "readonly", (t) =>
              n._s.getBundleMetadata(t, e.id)
            )
      ...
      return (
        await _a(t, o.Lu, /* remoteEvent */ void 0),
        // Save metadata, so loading the same bundle will skip.
        await (function (t, e) {
          const n = K(t);
          return n.persistence.runTransaction("Save bundle", "readwrite", (t) =>
            n._s.saveBundleMetadata(t, e)
          );
        })(
          /**
      ...
      return (
        $("SyncEngine", `Loading bundle failed with ${t}`),
        n._failWith(t),
        Promise.resolve(new Set())
      );
    }
 ...
 */ class Da extends Sa {
  ...
  async initialize(t) {
    await super.initialize(t),
      await this.Ta.initialize(this, t),
      // Enqueue writes from a previous session
      await Va(this.Ta.syncEngine),
      await wu(this.Ta.remoteStore),
      // NOTE: This will immediately call the listener, so we make sure to
      // set it after localStore / remoteStore are started.
      await this.persistence.Ts(
        () => (
          this.gcScheduler &&
  ...
  ya(t) {
    const e = Yr(t.databaseInfo.databaseId, t.databaseInfo.persistenceKey),
      n =
        void 0 !== this.cacheSizeBytes
          ? gr.withCacheSize(this.cacheSizeBytes)
          : gr.DEFAULT;
    return new zr(
 ...
 */ class Ca extends Da {
  ...
  async initialize(t) {
    ...
    this.sharedClientState instanceof Fo &&
 ...
 */ class xa {
  async initialize(t, e) {
    this.localStore ||
      ...
      (this.syncEngine = this.createSyncEngine(
        e,
        /* startAsPrimary=*/ !t.synchronizeTabs
      )),
      (this.sharedClientState.onlineStateHandler = (t) =>
        na(this.syncEngine, t, 1 /* SharedClientState */)),
      (this.remoteStore.remoteSyncer.handleCredentialChange = wa.bind(
        null,
        this.syncEngine
      )),
  ...
  createDatastore(t) {
    const e = jo(t.databaseInfo.databaseId),
      n = ((s = t.databaseInfo), new Ko(s));
    var s;
    /** Return the Platform-specific connectivity monitor. */ return (function (
      t,
      e,
      n,
      s
  ...
  createRemoteStore(t) {
    return (
      ...
      (n = this.datastore),
      (s = t.asyncQueue),
      (i = (t) => na(this.syncEngine, t, 0 /* RemoteStore */)),
      (r = Lo.vt() ? new Lo() : new Bo()),
      new Zo(e, n, s, i, r)
    );
    var e, n, s, i, r;
 ...
 */ class Ma {
  constructor(
    ...
    (this.Ra = t),
      ...
      (this.Pa = new TextDecoder("utf-8")),
      // Read the metadata (which is the first element).
      this.ba().then(
        (t) => {
          t && t.Mu()
            ? this.metadata.resolve(t.payload.metadata)
  ...
  async ma() {
    ...
    return await this.getMetadata(), this.ba();
  }
  /**
   ...
   */ async Va() {
    ...
    t < 0 &&
      this.va("Reached the end of bundle when a length string is expected.");
   ...
   */ async Sa(t) {
    ...
    const e = this.Pa.decode(this.buffer.slice(0, t));
...
class Oa {
  ...
  async lookup(t) {
    ...
    const e = await (async function (t, e) {
      const n = K(t),
        ...
        r = await n._o("BatchGetDocuments", s, i),
        o = new Map();
      r.forEach((t) => {
        const e = bs(n.M, t);
  ...
  delete(t) {
    this.write(new On(t, this.precondition(t))),
      this.writtenDocs.add(t.toString());
  }
  async commit() {
...
class Fa {
  ...
  Ma(t) {
    this.xa > 0 && this.Oa(t)
      ? ((this.xa -= 1),
        this.asyncQueue.enqueueAndForget(() => (this.Na(), Promise.resolve())))
...
class $a {
  constructor(
    ...
    (this.authCredentials = t),
      ...
      (this.asyncQueue = n),
      (this.databaseInfo = s),
      (this.user = C.UNAUTHENTICATED),
      (this.clientId = it.R()),
      (this.authCredentialListener = () => Promise.resolve()),
      (this.appCheckCredentialListener = () => Promise.resolve()),
      this.authCredentials.start(n, async (t) => {
        O("FirestoreClient", "Received user=", t.uid),
      ...
      this.appCheckCredentials.start(
        n,
        (t) => (
          O("FirestoreClient", "Received new app check token=", t),
...
async function La(t, e) {
  ...
  await e.initialize(n, s),
    ...
    t.setCredentialChangeListener((t) => Ru(e.remoteStore, t)),
    t.setAppCheckTokenChangeListener((t, n) => Ru(e.remoteStore, n)),
...
async function Wa(t) {
  const e = await qa(t),
    n = e.eventManager;
  return (
    (n.onListen = Yu.bind(null, e.syncEngine)),
    (n.onUnlisten = Zu.bind(null, e.syncEngine)),
    n
  );
}

/** Enables the network connection and re-enqueues all pending operations. */ function za(
  t
) {
...
/** Disables the network connection. Pending operations will not complete. */ function Ha(
  t
) {
  return t.asyncQueue.enqueue(async () => {
    const e = await Ka(t),
        ...
        const r = new ka({
            next: (r) => {
              ...
              !u && r.fromCache
                ...
                : u && r.fromCache && s && "server" === s.source
                ? i.reject(
                    new Q(
                      G.UNAVAILABLE,
...
function Xa(t, e) {
  ...
  return (
    t.asyncQueue.enqueueAndForget(async () =>
      (async function (t, e, n) {
        try {
          const s = await lo(t, e, /* usePreviousResults= */ !0),
            i = new Wu(e, s._i),
            r = i.Wu(s.documents),
...
function sc(t, e) {
  return t.asyncQueue.enqueue(async () =>
    (function (t, e) {
      const n = K(t);
      return n.persistence.runTransaction("Get named query", "readonly", (t) =>
        n._s.getNamedQuery(t, e)
      );
    })(await Ga(t), e)
  );
}
...
function _c(t, e, n, s = {}) {
  ...
  if (
    ...
    if ("string" == typeof s.mockUserToken)
      (e = s.mockUserToken), (n = C.MOCK_USER);
    else {
      // Let createMockUserToken validate first (catches common mistakes like
      // invalid field "uid" and missing field "sub" / "user_id".)
      e = createMockUserToken(
        s.mockUserToken,
        null === (i = t._app) || void 0 === i ? void 0 : i.options.projectId
      );
 ...
 */ class gc extends mc {
   ...
   */ get parent() {
    ...
    return t.isEmpty()
      ? null
      : new wc(this.firestore, /* converter= */ null, new xt(t));
  }
  withConverter(t) {
...
function yc(t, e, ...n) {
  if (
    ((t = getModularInstance(t)), rc("collection", "path", e), t instanceof dc)
  ) {
    const s = _t.fromString(e, ...n);
    return ac(s), new gc(t, /* converter= */ null, s);
  }
  {
    if (!(t instanceof wc || t instanceof gc))
      throw new Q(
        G.INVALID_ARGUMENT,
        "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore"
      );
    const s = t._path.child(_t.fromString(e, ...n));
    return ac(s), new gc(t.firestore, /* converter= */ null, s);
  }
}
 ...
 */ function pc(t, e) {
  if (
    ((t = hc(t, dc)),
    rc("collectionGroup", "collection id", e),
    e.indexOf("/") >= 0)
  )
    throw new Q(
      G.INVALID_ARGUMENT,
...
function Ic(t, e, ...n) {
  if (
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = it.R()),
    rc("doc", "path", e),
    t instanceof dc)
  ) {
    const s = _t.fromString(e, ...n);
    return uc(s), new wc(t, /* converter= */ null, new xt(s));
  }
  {
    if (!(t instanceof wc || t instanceof gc))
      throw new Q(
    ...
    return (
      uc(s),
      new wc(t.firestore, t instanceof gc ? t.converter : null, new xt(s))
    );
  }
}
 ...
 */ function Tc(t, e) {
  return (
    ...
    (t instanceof wc || t instanceof gc) &&
      (e instanceof wc || e instanceof gc) &&
  ...
  constructor() {
    ...
    (this.Fa = Promise.resolve()),
      ...
      (this.Qa = () => {
        const t = Qo();
        t &&
          O("AsyncQueue", "Visibility state changed to " + t.visibilityState),
          this.No.bo();
      });
    const t = Qo();
    t &&
      "function" == typeof t.addEventListener &&
      t.addEventListener("visibilitychange", this.Qa);
  }
  get isShuttingDown() {
    return this.Ba;
  }
  ...
  enterRestrictedMode(t) {
    if (!this.Ba) {
      ...
      e &&
        ...
        e.removeEventListener("visibilitychange", this.Qa);
    }
  }
  enqueue(t) {
    if ((this.ja(), this.Ba))
   ...
   */ Xa(t) {
    ...
    return this.Ja().then(() => {
      ...
      for (const e of this.La)
        if ((e.skipDelay(), "all" /* All */ !== t && e.timerId === t)) break;
      return this.Ja();
    });
  }
  /**
 ...
 * limitations under the License.
 */
/** DOMException error code constants. */ const bc = -1;
 ...
 */ function xc(t, e) {
  ...
  return kc(
    n,
    i,
    new Da(i, s.cacheSizeBytes, null == e ? void 0 : e.forceOwnership)
  );
}
        ...
        if (
          !(
            ...
            (function (t) {
              if ("FirebaseError" === t.name)
                return (
                  t.code === G.FAILED_PRECONDITION || t.code === G.UNIMPLEMENTED
                );
              if (
 ...
 */ function Oc(t) {
  return (function (t) {
    const e = new j();
    return (
      t.asyncQueue.enqueueAndForget(async () => oa(await ja(t), e)), e.promise
    );
  })(Dc((t = hc(t, Vc))));
}
 ...
 */ function Uc(t, e) {
  return sc(Dc((t = hc(t, Vc))), e).then((e) =>
    e ? new mc(t, null, e.query) : null
  );
}
...
/** The result of parsing document data (e.g. for a setData call). */ class Hc {
  ...
  toMutation(t, e) {
    return null !== this.fieldMask
      ? new xn(t, this.data, this.fieldMask, e, this.fieldTransforms)
      : new Cn(t, this.data, e, this.fieldTransforms);
  }
}
...
/** A "context" object passed around while parsing user data. */ class Xc {
  ...
  tc() {
    ...
    // within arrays.
    if (this.path)
      for (let t = 0; t < this.path.length; t++) this.rc(this.path.get(t));
  }
  rc(t) {
    if (0 === t.length) throw this.ac("Document fields must not be empty");
    if (Yc(this.ec) && zc.test(t))
...
/** Parse document data from a set() call. */ function eh(
  t,
  e,
  n,
  s,
  ...
  const o = t.lc(
    r.merge || r.mergeFields ? 2 /* MergeSet */ : 0 /* Set */,
    e,
    n,
    i
  );
...
class rh extends jc {
  ...
  _toFieldTransform(t) {
    const e = sh(this, t, /*array=*/ !0),
      n = this.fc.map((t) => lh(t, e)),
      s = new dn(n);
...
/** Parse update data from a list of field/value arguments. */ function ch(
  t,
  e,
  n,
  s,
 ...
 */ function lh(t, e) {
  if (
    ...
    return _h("Unsupported field value:", e, t), fh(t, e);
  if (t instanceof jc)
  ...
  if (
    ...
    if (e.settings.ic && 4 /* ArrayArgument */ !== e.ec)
  ...
  return (function (t, e) {
    if (null === (t = getModularInstance(t)))
      return {
        nullValue: "NULL_VALUE",
      };
 ...
 */ function wh(t, e, n) {
  if (
    ...
    // FieldPath.
    (e = getModularInstance(e)) instanceof Kc
  )
...
function yh(t, e, n, s, i) {
  ...
  return (
    (r || o) &&
      ...
      o && (a += ` in document ${i}`),
      (a += ")")),
    new Q(G.INVALID_ARGUMENT, u + t + a)
  );
}

/** Checks `haystack` if FieldPath `needle` is present. Runs in O(n). */ function ph(
  t,
  e
) {
 ...
 */ class bh {
  ...
  constructor(t, e, n, s) {
    (this._firestore = t),
      (this._userDataWriter = e),
      (this._snapshot = s),
      (this.metadata = new Ah(s.hasPendingWrites, s.fromCache)),
      (this.query = n);
  }
            ...
            }
            {
              ...
              return t._snapshot.docChanges
                ...
                .map((e) => {
                  ...
                  return (
                    0 /* Added */ !== e.type &&
                      ((i = n.indexOf(e.doc.key)), (n = n.delete(e.doc.key))),
                    1 /* Removed */ !== e.type &&
 ...
 */ function vh(t, e) {
  return t instanceof Rh && e instanceof Rh
 ...
 * limitations under the License.
 */ function Sh(t) {
  if ("L" /* Last */ === t.limitType && 0 === t.explicitOrderBy.length)
    throw new Q(
      G.UNIMPLEMENTED,
...
class xh extends Dh {
  ...
  _apply(t) {
    const e = th(t.firestore),
      n = (function (t, e, n, s, i, r, o) {
        let u;
        if (i.isKeyField()) {
          if (
            "array-contains" /* ARRAY_CONTAINS */ === r ||
            "array-contains-any" /* ARRAY_CONTAINS_ANY */ === r
          )
            throw new Q(
              G.INVALID_ARGUMENT,
...
function Lh(...t) {
  return new Bh("startAt", t, /*inclusive=*/ !0);
}

function Uh(...t) {
  return new Bh("startAfter", t, /*inclusive=*/ !1);
}
...
function Kh(...t) {
  return new qh("endBefore", t, /*inclusive=*/ !1);
}
...
/** Helper function to create a bound from a document or fields */ function Qh(
  t,
  e,
  n,
  s
  ...
  if (((n[0] = getModularInstance(n[0])), n[0] instanceof Ih))
    return (function (t, e, n, s, i) {
      ...
      // results.
      for (const n of ze(t))
        if (n.field.isKeyField()) r.push(qt(e, s.key));
        else {
      ...
      for (let r = 0; r < i.length; r++) {
        ...
        if (o[r].field.isKeyField()) {
          if ("string" != typeof a)
            throw new Q(
              G.INVALID_ARGUMENT,
              `Invalid query. Expected a string for document ID in ${s}(), but got a ${typeof a}`
            );
          if (!We(t) && -1 !== a.indexOf("/"))
            throw new Q(
              G.INVALID_ARGUMENT,
              `Invalid query. When querying a collection and ordering by documentId(), the value passed to ${s}() must be a plain document ID, but '${a}' contains a slash.`
            );
          const n = t.path.child(_t.fromString(a));
          if (!xt.isDocumentKey(n))
            throw new Q(
              G.INVALID_ARGUMENT,
...
function jh(t, e, n) {
  ...
  throw new Q(
    G.INVALID_ARGUMENT,
    `Invalid query. When querying with documentId(), you must provide a valid string or a DocumentReference, but it was: ${cc(
      n
    )}.`
  );
}
 ...
 */ class Xh {
  ...
  set(t, e, n) {
    ...
    const s = Zh(t, this._firestore),
      i = Jh(s.converter, e, n),
      r = eh(
        this._dataReader,
        "WriteBatch.set",
        s._key,
  ...
  update(t, e, n, ...s) {
    this._verifyNotCommitted();
    const i = Zh(t, this._firestore);
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    let r;
    return (
      (r =
        "string" == typeof (e = getModularInstance(e)) || e instanceof Kc
          ? ch(this._dataReader, "WriteBatch.update", i._key, e, n, s)
          : ah(this._dataReader, "WriteBatch.update", i._key, e)),
      this._mutations.push(r.toMutation(i._key, An.exists(!0))),
      this
    );
  }
  /**
   ...
   */ delete(t) {
    this._verifyNotCommitted();
    const e = Zh(t, this._firestore);
    return (
      (this._mutations = this._mutations.concat(new On(e._key, An.none()))),
      this
    );
  }
  /**
...
function tl(t) {
  ...
  return Ya(Dc(e), t._key).then((n) => _l(e, t, n));
}
  ...
  return Ja(n, t._key).then(
    (n) =>
      new Rh(
        ...
        t._key,
        n,
        new Ah(null !== n && n.hasLocalMutations, /* fromCache= */ !0),
        t.converter
      )
  );
}
 ...
 */ function il(t) {
  ...
  const e = hc(t.firestore, Vc),
    n = Dc(e),
    s = new el(e);
  return Sh(t._query), Za(n, t._query).then((n) => new bh(e, s, t, n));
}
 ...
 */ function rl(t) {
  ...
  const e = hc(t.firestore, Vc),
    n = Dc(e),
    s = new el(e);
  return Xa(n, t._query).then((n) => new bh(e, s, t, n));
}
 ...
 */ function ol(t) {
  ...
  return Za(n, t._query, {
    source: "server",
  }).then((n) => new bh(e, s, t, n));
}

function ul(t, e, n) {
  t = hc(t, wc);
  const s = hc(t.firestore, Vc),
    i = Jh(t.converter, e, n);
  return dl(s, [
    eh(th(s), "setDoc", t._key, i, null !== t.converter, n).toMutation(
      t._key,
      An.none()
    ),
  ]);
...
function al(t, e, n, ...s) {
  ...
  o =
    "string" ==
      ...
      ? ch(r, "updateDoc", t._key, e, n, s)
      : ah(r, "updateDoc", t._key, e);
  return dl(i, [o.toMutation(t._key, An.exists(!0))]);
}
 ...
 */ function cl(t) {
  return dl(hc(t.firestore, Vc), [new On(t._key, An.none())]);
}
...
function ll(t, ...e) {
  ...
  if (Rc(e[o])) {
    ...
    (e[o] = null === (n = t.next) || void 0 === n ? void 0 : n.bind(t)),
      (e[o + 1] = null === (s = t.error) || void 0 === s ? void 0 : s.bind(t)),
      (e[o + 2] =
  ...
  return (function (t, e, n, s) {
    const i = new ka(s),
      r = new Lu(e, i, n);
    return (
      t.asyncQueue.enqueueAndForget(async () => Mu(await Wa(t), r)),
      () => {
 ...
 */ function dl(t, e) {
  return (function (t, e) {
    const n = new j();
    return (
      t.asyncQueue.enqueueAndForget(async () => ta(await ja(t), e, n)),
      n.promise
    );
  })(Dc(t), e);
}
 ...
 */ function _l(t, e, n) {
  ...
  return new Rh(
    ...
    e._key,
    s,
    new Ah(n.hasPendingWrites, n.fromCache),
    e.converter
  );
}
 ...
 */ class wl extends class {
  ...
  update(t, e, n, ...s) {
    ...
    return (
      (r =
        "string" == typeof (e = getModularInstance(e)) || e instanceof Kc
          ? ch(this._dataReader, "Transaction.update", i._key, e, n, s)
          : ah(this._dataReader, "Transaction.update", i._key, e)),
      ...
      .then(
        (t) =>
          new Rh(
            ...
            e._key,
            t._document,
            new Ah(/* hasPendingWrites= */ !1, /* fromCache= */ !1),
            e.converter
          )
      );
  }
 ...
 */ function ml(t, e) {
  return ec(Dc((t = hc(t, Vc))), (n) => e(new wl(t, n)));
}
 ...
 * writes.
 */ function El(t) {
  return Dc((t = hc(t, Vc))), new Xh(t, (e) => dl(t, e));
}
 ...
 */ function Al(t, e) {
      ...
      "string" == typeof e
        ? (function (t) {
            try {
              ...
              throw new Q(
                G.INVALID_ARGUMENT,
                "Failed to parse JSON:" + t.message
              );
            }
          })(e)
        : e,
  ...
  if (Array.isArray(n.indexes))
    for (const t of n.indexes) {
      const e = Rl(t, "collectionGroup"),
        n = [];
      if (Array.isArray(t.fields))
        for (const e of t.fields) {
          const t = gh("setIndexConfiguration", Rl(e, "fieldPath"));
          "CONTAINS" === e.arrayConfig
            ? n.push(new oe(t, 2 /* CONTAINS */))
            : "ASCENDING" === e.order
            ? n.push(new oe(t, 0 /* ASCENDING */))
            : "DESCENDING" === e.order && n.push(new oe(t, 1 /* DESCENDING */));
        }
 ...
 */ !(function (t, e = !0) {
  !(function (t) {
      ...
      new Component(
        ...
        (t, { options: n }) => {
          const s = t.getProvider("app").getImmediate(),
            i = new Vc(
              s,
              new J(t.getProvider("auth-internal")),
              new tt(t.getProvider("app-check-internal"))
            );
          return (
            (n = Object.assign(
              {
    ...
    registerVersion(D, "3.4.8", t),
    // BUILD_TARGET will be replaced by values like esm5, esm2017, cjs5, etc during the compilation
    registerVersion(D, "3.4.8", "esm2017");
})();

export {
  Hh as AbstractUserDataWriter,
  Qc as Bytes,
  bc as CACHE_SIZE_UNLIMITED,
  ...
  Q as FirestoreError,
  Wc as GeoPoint,
  Pc as LoadBundleTask,
  mc as Query,
  Dh as QueryConstraint,
  Ph as QueryDocumentSnapshot,
  bh as QuerySnapshot,
  ...
  dl as executeWrite,
  tl as getDoc,
  nl as getDocFromCache,
  sl as getDocFromServer,
  il as getDocs,
  rl as getDocsFromCache,
  ol as getDocsFromServer,
  Sc as getFirestore,
  Tl as increment,
  ...
  Uc as namedQuery,
  ll as onSnapshot,
  fl as onSnapshotsInSync,
  Mh as orderBy,
  Ch as query,
  Ec as queryEqual,
  Tc as refEqual,
  ml as runTransaction,
  yl as serverTimestamp,
  ul as setDoc,
  M as setLogLevel,
  vh as snapshotEqual,
  Uh as startAfter,
